...
import edu.clemson.rsrg.absyn.expressions.mathexpr.RecpExp;
import edu.clemson.rsrg.absyn.expressions.mathexpr.TypeReceptaclesExp;
...
/**
 * <p>
 * This class determines if an {@link Exp} is contains any {@link RecpExp} or {@link TypeReceptaclesExp}. This visitor
...
public class ReceptaclesExpExtractor extends TreeWalkerVisitor {
    ...
    public final void preProgramExp(ProgramExp exp) {
        ...
        throw new SourceErrorException("[VCGenerator] Found: " + exp + " in a formal specification!",
                exp.getLocation());
    }
