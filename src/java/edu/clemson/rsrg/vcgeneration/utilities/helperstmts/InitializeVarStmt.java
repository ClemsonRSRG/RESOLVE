...
/**
 * <p>
 * This is the class that builds a special kind of statement that acts as a placeholder for initialize a variable
 * declaration. Since the user cannot supply their own {@code _Initialize} statements, any instances of this class will
 * solely be created by the {@link VCGenerator} and/or by our various different {@code proof rules}.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class InitializeVarStmt extends Statement {
    ...
    /**
     * <p>
     * The symbol table entry representing program type associated with the variable we are trying to initialize.
     * </p>
     */
    ...
    /**
     * <p>
     * This constructs an helper statement that indicates initialization logic for a variable happens here.
     * </p>
     *
     * @param varDec
     *            A variable declaration.
     * @param symbolTableEntry
     *            The program type entry associated with {@code varDec}.
     * @param isGenericVar
     *            A flag that indicates if this is variable with generic program type.
     */
    public InitializeVarStmt(VarDec varDec, SymbolTableEntry symbolTableEntry, boolean isGenericVar) {
    ...
    /**
     * <p>
     * This method returns the symbol table entry associated with the program type for the variable declaration we are
    ...
    /**
     * <p>
     * This method returns whether or not the program variable we are trying to initialize has a generic program type.
     * </p>
     *
     * @return {@code true} if has generic program type, {@code false} otherwise.
     */
    ...
    protected final Statement copy() {
        return new InitializeVarStmt((VarDec) myVarDec.clone(), myVarTypeEntry, myIsGenericVarFlag);
    }
}
