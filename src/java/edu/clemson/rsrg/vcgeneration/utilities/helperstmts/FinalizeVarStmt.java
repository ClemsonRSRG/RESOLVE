...
/**
 * <p>
 * This is the class that builds a special kind of statement that acts as a placeholder for finalizing a variable
 * declaration. Since the user cannot supply their own {@code _Finalize} statements, any instances of this class will
...
public class FinalizeVarStmt extends Statement {
    ...
    /**
     * <p>
     * The symbol table entry representing program type associated with the variable we are trying to finalize.
     * </p>
     */
    ...
    /**
     * <p>
     * This constructs an helper statement that indicates finalization logic for a variable with known type happens
     * here.
     * </p>
     *
     * @param varDec
     *            A variable declaration with known type.
