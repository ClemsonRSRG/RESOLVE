...
/**
 * <p>
 * This class stores all information pertinent to an {@link FacilityDec} that will be useful for the various different
 * {@code Proof Rules}. This includes {@link FacilityDec FacilityDec's} formal parameters in the
 * specifications/implementations and their actual arguments in the instantiation. It also includes the shared state
 * variables and types declarations that will be instantiated.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class InstantiatedFacilityDecl {
    ...
    /**
     * <p>
     * This contains all the {@code Concept}'s formal arguments and its instantiated actual arguments.
     * </p>
     */
    ...
    /**
     * <p>
     * This contains all the {@code Concept Realization}'s formal arguments and its instantiated actual arguments.
     * </p>
     */
     ...
     *
     * @param dec
     *            The instantiated {@code Facility} declaration.
     * @param conceptSharedStates
     *            The shared states in the instantiating {@code Concept}.
     * @param conceptDeclaredTypes
     *            The types in the instantiating {@code Concept}.
     * @param cFormalParamList
     *            The formal parameters from the {@code Concept}.
     * @param cActualArgList
     *            The processed arguments used to instantiate the {@code Concept}.
     * @param crFormalParamList
     *            The formal parameters from the {@code Concept Realization}.
     * @param crActualArgList
     *            The processed arguments used to instantiate the {@code Concept Realization}.
     * @param enhSpecRealizItems
     *            A list of {@link InstantiatedEnhSpecRealizItem InstantiatedEnhSpecRealizItems}.
     * @param isLocalFacDec
     *            A flag that indicates if this is a local {@link FacilityDec}.
     */
    public InstantiatedFacilityDecl(FacilityDec dec, List<SharedStateDec> conceptSharedStates,
            List<TypeFamilyDec> conceptDeclaredTypes, List<VarExp> cFormalParamList, List<Exp> cActualArgList,
            List<VarExp> crFormalParamList, List<Exp> crActualArgList,
            List<InstantiatedEnhSpecRealizItem> enhSpecRealizItems, boolean isLocalFacDec) {
        myInstantiatedFacilityDec = dec;
        myConceptDeclaredTypes = conceptDeclaredTypes;
        myConceptParamArgs = new FormalActualLists(cFormalParamList, cActualArgList);
        myConceptRealizParamArgs = new FormalActualLists(crFormalParamList, crActualArgList);
    ...
    public final boolean equals(Object o) {
        ...
        if (!myConceptSharedStates.equals(decl.myConceptSharedStates))
            return false;
        if (!myInstantiatedEnhSpecRealizItems.equals(decl.myInstantiatedEnhSpecRealizItems))
            return false;
    ...
    /**
     * <p>
     * This method the list of {@link TypeFamilyDec TypeFamilyDecs} instantiated by this {@code Facility}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a {@link FormalActualLists} containing the {@code Concept}'s formal and actual arguments for
     * the instantiated {@code Facility}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a {@link FormalActualLists} containing the {@code Concept Realization}'s formal and actual
     * arguments for the instantiated {@code Facility}.
     * </p>
     *
     * @return A {@link FormalActualLists} containing the formal parameters and the instantiation arguments.
     */
    ...
    /**
     * <p>
     * This method the list of {@link SharedStateDec SharedStateDecs} instantiated by this {@code Facility}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a list of {@link InstantiatedEnhSpecRealizItem} containing the {@code Enhancement's} and
     * {@code Enhancement Realization's} formal and actual arguments for the instantiated {@code Facility}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method checks to see if this is a local {@code Facility} declaration.
     * </p>
     *
