...
/**
 * <p>
 * An helper class that stores the formal parameters for a module and the processed instantiation arguments from a
 * {@link FacilityDec}.
 * </p>
 *
 * @author Yu-Shan Sun
...
public class FormalActualLists {
    ...
    /**
     * <p>
     * A list that will be populated with the arguments used to instantiate a module.
     * </p>
     */
    ...
    /**
     * <p>
     * A list that will be populated with the instantiating a module's formal parameters.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates an object that stores the formal parameters from a module and the processed instantiating arguments
     * from a {@link FacilityDec}.
     * </p>
     *
     * @param formalParamList
     *            The formal parameters from a module.
     * @param actualArgList
     *            The processed arguments used to instantiate a module.
     */
    ...
    /**
     * <p>
     * This method returns a deep copy of the processed arguments from the instantiated {@code Facility}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a deep copy of the formal parameters from the module we are trying to instantiate.
     * </p>
     *
