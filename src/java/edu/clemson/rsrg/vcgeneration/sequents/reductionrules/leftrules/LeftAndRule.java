...
import edu.clemson.rsrg.absyn.expressions.mathexpr.BetweenExp;
...
/**
 * <p>
 * This class contains the logic for applying the {@code left and} rule.
 * </p>
 *
 * @author Yu-Shan Sun
 *
 * @version 1.0
 */
public class LeftAndRule extends AbstractReductionRuleApplication implements ReductionRuleApplication {
    ...
    /**
     * <p>
     * This creates a new application of the {@code left and} rule.
     * </p>
     *
    ...
    public final List<Sequent> applyRule() {
        if (myOriginalExp instanceof BetweenExp) {
            ...
            Sequent resultingSequent = new Sequent(myOriginalSequent.getLocation(), newAntecedents,
