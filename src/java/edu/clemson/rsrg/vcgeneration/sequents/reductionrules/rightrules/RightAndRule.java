 ...
 * @version 1.0
 */
public class RightAndRule extends AbstractReductionRuleApplication implements ReductionRuleApplication {
    ...
    public final List<Sequent> applyRule() {
        if (myOriginalExp instanceof BetweenExp) {
            ...
            for (Exp joiningExp : originalExpAsBetweenExp.getJoiningExps()) {
                ...
                newConsequents.add(copyExp(joiningExp, myOriginalExp.getLocationDetailModel()));
            ...
            Sequent resultingSequent1 = new Sequent(myOriginalSequent.getLocation(),
                    copyExpList(myOriginalSequent.getAntecedents(), null), newConsequents1);
            myResultingSequents.add(resultingSequent1);
            Sequent resultingSequent2 = new Sequent(myOriginalSequent.getLocation().clone(),
                    copyExpList(myOriginalSequent.getAntecedents(), null), newConsequents2);
