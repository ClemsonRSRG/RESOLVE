 ...
 * @version 1.0
 */
public class LeftImpliesRule extends AbstractReductionRuleApplication implements ReductionRuleApplication {
    ...
    public final List<Sequent> applyRule() {
        if (myOriginalExp instanceof InfixExp) {
            ...
            Sequent resultingSequent1 = new Sequent(myOriginalSequent.getLocation(), newAntecedents1, newConsequents1);
            myResultingSequents.add(resultingSequent1);
            Sequent resultingSequent2 = new Sequent(myOriginalSequent.getLocation(), newAntecedents2, newConsequents2);
