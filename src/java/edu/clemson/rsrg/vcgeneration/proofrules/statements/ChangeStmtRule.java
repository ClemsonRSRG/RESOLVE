...
import edu.clemson.rsrg.absyn.statements.ChangeStmt;
 ...
 * @version 1.0
 */
public class ChangeStmtRule extends AbstractProofRuleApplication implements ProofRuleApplication {
     ...
     */
    public ChangeStmtRule(ChangeStmt changeStmt, AssertiveCodeBlock block, VerificationContext context, STGroup stGroup,
            ST blockModel) {
    ...
    public final void applyRule() {
        ...
        for (Exp exp : changeVars) {
            VCVarExp vcVarExp = Utilities.createVCVarExp(myCurrentAssertiveCodeBlock, exp.clone());
