...
/**
 * <p>
 * This class contains the logic for applying the {@code confirm} rule to a {@link ConfirmStmt}.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class ConfirmStmtRule extends AbstractProofRuleApplication implements ProofRuleApplication {
     ...
     */
    public ConfirmStmtRule(ConfirmStmt confirmStmt, AssertiveCodeBlock block, VerificationContext context,
    ...
    public final void applyRule() {
        ...
        if (myConfirmStmt.getSimplify() && VarExp.isLiteralTrue(myConfirmStmt.getAssertion())) {
            ...
            stepModel.add("proofRuleName", getRuleDescription() + " and Simplified").add("currentStateOfBlock",
    ...
    private List<VerificationCondition> buildNewVCs(ST stepModel) {
        ...
        Sequent sequentToBeReduced = new Sequent(myConfirmStmt.getLocation(), new ArrayList<Exp>(),
        ...
        for (Sequent s : resultSequents) {
            ...
            vcs.add(new VerificationCondition(myConfirmStmt.getLocation().clone(), s.clone(),
                    myImpactingReducedSequentMap.get(s), findLocationDetailModel(s)));
        }
    ...
    /**
     * <p>
     * This method finds the location details that will be associated with a {@code VC}.
     * </p>
     *
     * @param sequent
     *            A {@link Sequent}.
