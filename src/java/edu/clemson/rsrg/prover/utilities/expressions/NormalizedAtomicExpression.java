...
public class NormalizedAtomicExpression {
     ...
     * @param intArray
     *            An integer array representing each of the symbols in this expression.
     */
    ...
    public final boolean equals(Object o) {
        if (o instanceof NormalizedAtomicExpression) {
            ...
            return Arrays.equals(myExpression, other.myExpression) && other.myRegistry == myRegistry;
        }
     ...
     *
     * @param justArguments
     *            A flag that indicates that we are only want arguments expressions.
     *
    ...
    /**
     * <p>
     * This method returns the {@code NormalizedAtomicExpression} in string format.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns an array containing {@code n} if an argument is used at position {@code n}. A {@code 0}
     * denotes an operator and {@code -1} denotes a congruence class.
     * </p>
     *
     * @param sint
     *            Index value we are searching for.
     *
     ...
     * </p>
     *
     * @return {@code true} if we have a variable named operation, {@code false} otherwise.
     */
    ...
    /**
     * <p>
     * This method returns the integer index value for the symbol located at the specified position.
     * </p>
     *
     * @param position
     *            A position in the expression.
     *
     ...
     *            Original operator.
     * @param repl
     *            Replacement operation operator.
     *
     * @return A new {@link NormalizedAtomicExpression} with replacements or {@code this}.
     */
    ...
    /**
     * <p>
     * This method returns an integer array containing all rooted literals. Note any {@code -1} means it is a wildcard.
     * </p>
     *
     * @param overMap
     *            A map from symbol to symbol.
     * @param vc_Reg
     *            A registry for the {@code VC} we are processing.
     *
    ...
    final int[] rootedLiterals(Map<String, String> overMap, Registry vc_Reg) {
        ...
        for (int i = 0; i <= myExpression.length; ++i) {
            int expI = (i < myExpression.length) ? myExpression[i] : myClassConstant;
    ...
    /**
     * <p>
     * This method returns a new normalized atomic expression with the root operators.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a string array containing all the unmapped wildcard operators. Note that {@code ""} means it
     * is being mapped.
     * </p>
     *
     * @param overMap
    ...
    /**
     * <p>
     * An helper method for retrieving the number of universally quantifiers in this expression.
     * </p>
     *
    ...
    private int numberOfQuants() {
        ...
        for (String k : getOperatorsAsStrings(false).keySet()) {
            if (myRegistry.getUsage(k).equals(Registry.Usage.FORALL)
                    || myRegistry.getUsage(k).equals(Registry.Usage.HASARGS_FORALL)
    ...
    /**
     * <p>
     * An helper class that compares the number of quantifiers in two {@link NormalizedAtomicExpression
    ...
    public static class numQuantsComparator implements Comparator<NormalizedAtomicExpression> {
         ...
         *
         * @param nae1
         *            A normalized atomic expression.
         * @param nae2
         *            Another normalized atomic expression
         *
         * @return Comparison results expressed as an integer.
         */
        @Override
        public final int compare(NormalizedAtomicExpression nae1, NormalizedAtomicExpression nae2) {
