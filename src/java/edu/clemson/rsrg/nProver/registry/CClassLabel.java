...
public class CClassLabel {
    ...
    public int getIndexToCClass() {
        return indexToCClass;
    }

    public void setIndexToCClass(int newClassDesignator) {
        indexToCClass = newClassDesignator;
    }

    public int getNextVarietalClass() {
        return nextVarietalClass;
    }

    public void setNextVarietalClass(int newIndex) {
        nextVarietalClass = newIndex;
    }

    public int getPrevVarietalClass() {
        return prevVarietalClass;
    }

    public void setPrevVarietalClass(int newIndex) {
        prevVarietalClass = newIndex;
    }

    public int getPlantationDesignator() {
        return plantationDesignator;
    }

    public void setPlantationDesignator(int newPlantationDesignator) {
        plantationDesignator = newPlantationDesignator;
    }
