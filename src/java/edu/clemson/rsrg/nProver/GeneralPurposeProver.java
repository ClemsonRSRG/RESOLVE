...
public class GeneralPurposeProver {
    ...
    private static final String FLAG_DESC_NUM_FAILED_VCS = "Number of failed VCs before halting the proving process";
    ...
    private static final Flag FLAG_VCSFAILED = new Flag(FLAG_SECTION_NAME, "vcsfailed", FLAG_DESC_NUM_FAILED_VCS,
