...
/**
 * <p>
 * This is the class for all the type definition declaration objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @author Yu-Shan Sun
...
public class TypeDefinitionDec extends Dec {
     ...
     *
     * @param name
     *            Name of the new type definition.
     * @param ty
     *            Model for the new type definition.
     */
