...
/**
 * <p>
 * This is the abstract base class for both the type representation and facility type representation objects that the
...
public abstract class AbstractTypeRepresentationDec extends Dec {
    ...
    /**
     * <p>
     * An helper constructor that allow us to store the name, raw type and convention for any objects created from a
     * class that inherits from {@code AbstractTypeRepresentationDec}.
     * </p>
     *
     * @param name
     ...
     *            Type convention.
     */
    protected AbstractTypeRepresentationDec(PosSymbol name, Ty ty, AssertionClause convention) {
    ...
    /**
     * <p>
     * Implemented by concrete subclasses of {@link AbstractTypeRepresentationDec} to manufacture a copy of themselves.
     * </p>
     *
     * @return A new {@link AbstractTypeRepresentationDec} that is a deep copy of the original.
     */
     ...
     */
    protected final String formRepresentationTy(int indentSize, int innerIndentInc) {
