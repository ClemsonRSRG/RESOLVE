...
/**
 * <p>
 * This is the class for all the shared state declaration objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @author Yu-Shan Sun
 * 
...
public class SharedStateDec extends Dec {
     ...
     * @param abstractStateVars
     *            List of abstract state variables.
     * @param constraint
     *            Shared state constraint.
     * @param initItem
     *            Initialization information for verification.
     */
    public SharedStateDec(PosSymbol name, List<MathVarDec> abstractStateVars, AssertionClause constraint,
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        // Init/Final
        sb.append(myStateInitItem.asString(indentSize + innerIndentInc, innerIndentInc));
        sb.append("\n");
