...
/**
 * <p>
 * This is the abstract base class for both the shared state realization and facility shared state realization objects
...
public abstract class AbstractSharedStateRealizationDec extends Dec {
    ...
    /**
     * <p>
     * An helper constructor that allow us to store the name and convention for any objects created from a class that
     * inherits from {@code AbstractSharedStateRealizationDec}.
     * </p>
     *
     * @param name
     ...
     */
    protected AbstractSharedStateRealizationDec(PosSymbol name, List<VarDec> stateVarDecs, AssertionClause convention) {
    ...
    public boolean equals(Object o) {
        ...
        AbstractSharedStateRealizationDec that = (AbstractSharedStateRealizationDec) o;
    ...
    /**
     * <p>
     * Implemented by concrete subclasses of {@link AbstractSharedStateRealizationDec} to manufacture a copy of
     * themselves.
     * </p>
     *
     * @return A new {@link AbstractSharedStateRealizationDec} that is a deep copy of the original.
     */
    ...
    /**
     * <p>
     * An helper method to copy all the programming variables in this shared state.
     * </p>
     *
