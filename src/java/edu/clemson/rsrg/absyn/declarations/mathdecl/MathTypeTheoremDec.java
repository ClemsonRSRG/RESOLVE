...
/**
 * <p>
 * This is the class for all the mathematical type theorem declarations that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class MathTypeTheoremDec extends Dec {
     ...
     *
     * @param name
     *            Name of the type theorem.
     * @param universalVars
     *            List of universally quantified variables for this type theorem.
     * @param assertion
     *            The expression that relates all variables in this type theorem.
     */
    public MathTypeTheoremDec(PosSymbol name, List<MathVarDec> universalVars, Exp assertion) {
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        sb.append(myAssertion.asString(indentSize + innerIndentInc + innerIndentInc, innerIndentInc));
        sb.append(";");
    ...
    /**
     * <p>
     * This method returns all universally quantified math variables in this type theorem.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the assertion that relates the variables this type theorem.
     * </p>
     *
    ...
    /**
     * <p>
     * This method checks to see if the assertion we have is a binding condition.
     * </p>
     *
     * @return {@code true} if the assertion is an {@code implies}, {@code false} otherwise.
     */
    public final boolean hasBindingCondition() {
        return myAssertion instanceof InfixExp && ((InfixExp) myAssertion).getOperatorAsString().equals("implies");
    }
