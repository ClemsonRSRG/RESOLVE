...
/**
 * <p>
 * This is the abstract base class for both the mathematical and programming variable declaration objects that the
...
public abstract class AbstractVarDec extends Dec {
    ...
    /**
     * <p>
     * An helper constructor that allow us to store the location, name and raw type of any objects created from a class
     * that inherits from {@code AbstractVarDec}.
     * </p>
     *
     * @param l
    ...
    /**
     * <p>
     * Implemented by concrete subclasses of {@link AbstractVarDec} to manufacture a copy of themselves.
     * </p>
     *
