...
/**
 * <p>
 * This is the class for all the concept module type parameter declaration objects that the compiler builds using the
 * ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
...
public class ConceptTypeParamDec extends Dec implements ModuleParameter {
     ...
     *
     * @param name
     *            A {@link PosSymbol} representing the type's name.
     */
