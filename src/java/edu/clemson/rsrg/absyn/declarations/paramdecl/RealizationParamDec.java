...
/**
 * <p>
 * This is the class for all the realization parameter declaration objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class RealizationParamDec extends Dec implements ModuleParameter {
    ...
    /**
     * <p>
     * This constructs a type representation that is passed as a parameter to a module.
     * </p>
     *
     * @param name
     *            A {@link PosSymbol} representing the name of the realization.
     * @param conceptName
     *            A {@link PosSymbol} representing the name of the concept.
     */
    ...
    /**
     * <p>
     * Returns the symbol representation of the concept name.
     * </p>
     *
