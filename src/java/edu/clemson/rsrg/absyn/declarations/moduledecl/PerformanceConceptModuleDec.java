...
/**
 * <p>
 * This is the class for the performance profiles for concept module declarations that the compiler builds using the
 * ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
...
public class PerformanceConceptModuleDec extends ModuleDec {
    ...
    /**
     * <p>
     * This constructor creates a "Performance Profile" for an {@code Concept} module representation.
     * </p>
     *
     * @param l
     ...
     */
    public PerformanceConceptModuleDec(Location l, PosSymbol name, List<ModuleParameterDec> parameterDecs,
            PosSymbol profileLongName, PosSymbol conceptName, List<UsesItem> usesItems, AssertionClause requires,
    ...
    protected final PerformanceConceptModuleDec copy() {
        ...
        return new PerformanceConceptModuleDec(cloneLocation(), myName.clone(), newParameterDecs,
                myProfileLongName.clone(), myConceptName.clone(), newUsesItems, myRequires.clone(), newDecs,
