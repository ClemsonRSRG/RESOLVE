...
/**
 * <p>
 * This is the class for the enhancement module declarations that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class EnhancementModuleDec extends ModuleDec {
     ...
     */
    public EnhancementModuleDec(Location l, PosSymbol name, List<ModuleParameterDec> parameterDecs,
            PosSymbol conceptName, List<UsesItem> usesItems, AssertionClause requires, List<Dec> decs,
    ...
    protected final EnhancementModuleDec copy() {
        ...
        return new EnhancementModuleDec(cloneLocation(), myName.clone(), newParameterDecs, myConceptName.clone(),
