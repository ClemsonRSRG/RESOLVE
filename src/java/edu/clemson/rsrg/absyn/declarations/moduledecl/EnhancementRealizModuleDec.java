...
/**
 * <p>
 * This is the class for the enhancement realization module declarations that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class EnhancementRealizModuleDec extends ModuleDec {
    ...
    /**
     * <p>
     * The performance profile associated with this module
     * </p>
     */
    ...
    /**
     * <p>
     * This constructor creates a "Enhancement Realization" module representation.
     * </p>
     *
     * @param l
     ...
     * @param profileName
     *            The performance profile name (if any) in {@link PosSymbol} format.
     ...
     */
    public EnhancementRealizModuleDec(Location l, PosSymbol name, List<ModuleParameterDec> parameterDecs,
            PosSymbol profileName, PosSymbol enhancementName, PosSymbol conceptName, List<UsesItem> usesItems,
            AssertionClause requires, List<Dec> decs, Map<ResolveFileBasicInfo, Boolean> moduleDependencies) {
    ...
    /**
     * <p>
     * This method returns the symbol representation of for the profile name.
     * </p>
     *
     * @return The name in {@link PosSymbol} format.
     */
    ...
    protected final EnhancementRealizModuleDec copy() {
        ...
        return new EnhancementRealizModuleDec(cloneLocation(), myName.clone(), newParameterDecs, newProfileName,
                myEnhancementName.clone(), myConceptName.clone(), newUsesItems, myRequires.clone(), newDecs,
