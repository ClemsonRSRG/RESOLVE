...
/**
 * <p>
 * This is the class for the concept realization module declarations that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class ConceptRealizModuleDec extends ModuleDec {
    ...
    /**
     * <p>
     * This constructor creates a "Concept Realization" module representation.
     * </p>
     *
     * @param l
     ...
     */
    public ConceptRealizModuleDec(Location l, PosSymbol name, List<ModuleParameterDec> parameterDecs,
            PosSymbol profileName, PosSymbol conceptName, List<UsesItem> usesItems, AssertionClause requires,
    ...
    protected final ConceptRealizModuleDec copy() {
        ...
        return new ConceptRealizModuleDec(cloneLocation(), myName.clone(), newParameterDecs, newProfileName,
                myConceptName.clone(), newUsesItems, myRequires.clone(), newDecs, newModuleDependencies);
    }
}
