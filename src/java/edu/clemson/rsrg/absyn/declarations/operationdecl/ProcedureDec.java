...
/**
 * <p>
 * This is the class for all the procedure declaration objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class ProcedureDec extends Dec {
    ...
    /**
     * <p>
     * This constructs a recursive procedure declaration.
     * </p>
     *
     * @param name
     *            A {@link PosSymbol} representing the procedure's name.
     * @param parameters
     *            A list of {@link ParameterVarDec} representing the procedure's parameter variables.
     * @param returnTy
     *            A {@link Ty} representing the procedure's return value type.
     * @param affects
     *            A {@link AffectsClause} representing the procedure's affects clause.
     * @param decreasing
     ...
     */
    public ProcedureDec(PosSymbol name, List<ParameterVarDec> parameters, Ty returnTy, AffectsClause affects,
            AssertionClause decreasing, List<FacilityDec> facDecs, List<VarDec> varDecs, List<Statement> statements,
    ...
    /**
     * <p>
     * This constructs a procedure declaration.
     * </p>
     *
     * @param name
     *            A {@link PosSymbol} representing the procedure's name.
     ...
     */
    public ProcedureDec(PosSymbol name, List<ParameterVarDec> parameters, Ty returnTy, AffectsClause affects,
            List<FacilityDec> facDecs, List<VarDec> varDecs, List<Statement> statements) {
        this(name, parameters, returnTy, affects, null, facDecs, varDecs, statements, false);
    }
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        // affects clause
        if (myAffects != null) {
            sb.append(myAffects.asString(indentSize + innerIndentInc, innerIndentInc));
            sb.append("\n");
        }
    ...
    public final boolean equals(Object o) {
        ...
        if (!myParameters.equals(that.myParameters))
            return false;
        if (myReturnTy != null ? !myReturnTy.equals(that.myReturnTy) : that.myReturnTy != null)
            return false;
    ...
    /**
     * <p>
     * This method returns the affects clause for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the decreasing clause for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the list of facility declarations for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the parameter variable declarations for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the raw return type for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the list of statements in for this procedure declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the list of variables for this procedure declaration.
     * </p>
     *
    ...
    protected final ProcedureDec copy() {
        ...
        return new ProcedureDec(myName.clone(), newParameters, newReturnTy, newAffects, newDecreasing, newFacilityDecs,
