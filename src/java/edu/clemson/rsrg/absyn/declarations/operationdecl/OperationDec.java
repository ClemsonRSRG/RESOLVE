...
/**
 * <p>
 * This is the class for all the operation declaration objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class OperationDec extends Dec implements ModuleParameter {
     ...
     *
     * @param name
     *            A {@link PosSymbol} representing the operation's name.
     * @param parameters
     *            A list of {@link ParameterVarDec} representing the operation's parameter variables.
     * @param returnTy
     *            A {@link Ty} representing the operation's return value type.
     * @param affects
     *            A {@link AffectsClause} representing the operation's affects clause.
     * @param requires
     ...
     */
    public OperationDec(PosSymbol name, List<ParameterVarDec> parameters, Ty returnTy, AffectsClause affects,
    ...
    /**
     * <p>
     * This method returns the parameter variable declarations for this operation declaration.
     * </p>
     *
    ...
    protected final OperationDec copy() {
        ...
        return new OperationDec(myName.clone(), newParameters, newReturnTy, newAffects, myRequires.clone(),
                myEnsures.clone());
    }
}
