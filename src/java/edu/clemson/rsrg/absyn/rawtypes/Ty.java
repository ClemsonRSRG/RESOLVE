...
/**
 * <p>
 * A {@link Ty} represents the <em>description</em> of a {@code Type}, as it is found in the RESOLVE source code. That
 * is, it is representation of a type in the abstract syntax tree before it is translated into a true {@code Type}.
 * </p>
 *
 * @version 2.0
 */
public abstract class Ty extends ResolveConceptualElement {
    ...
    /**
     * <p>
     * This method overrides the default clone method implementation for all the classes that extend from {@link Ty}.
     * </p>
     *
    ...
    public boolean equals(Object o) {
        ...
        if (myMathType != null ? !myMathType.equals(ty.myMathType) : ty.myMathType != null)
            return false;
        if (myMathTypeValue != null ? !myMathTypeValue.equals(ty.myMathTypeValue) : ty.myMathTypeValue != null)
            return false;
        return myProgramTypeValue != null ? myProgramTypeValue.equals(ty.myProgramTypeValue)
    ...
    public int hashCode() {
        ...
        result = 31 * result + (myProgramTypeValue != null ? myProgramTypeValue.hashCode() : 0);
        return result;
    }
