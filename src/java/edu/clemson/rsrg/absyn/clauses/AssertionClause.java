 ...
 */
package edu.clemson.rsrg.absyn.clauses;
...
/**
 * <p>
 * This is the class for all mathematical assertion clause objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @author Daniel Welch
 * @author Yu-Shan Sun
...
public class AssertionClause extends ResolveConceptualElement {
     ...
     * @param type
     *            Indicates which type of assertion clause.
     * @param assertionExp
     *            A {@link Exp} representing the mathematical assertion.
     */
    ...
    /**
     * <p>
     * This constructs a mathematical assertion clause with a {@code which_entails} assertion.
     * </p>
     *
     * @param l
     *            A {@link Location} representation object.
     ...
     * @param assertionExp
     *            A {@link Exp} representing the mathematical assertion.
     * @param whichEntailsExp
     *            A {@link Exp} representing the {@code which_entails} mathematical assertion.
     */
    public AssertionClause(Location l, ClauseType type, Exp assertionExp, Exp whichEntailsExp) {
        this(l, type, assertionExp, whichEntailsExp, new ArrayList<Exp>());
    }

    /**
     * <p>
     * This constructs a mathematical assertion clause with a {@code which_entails} assertion and a list of variable
     * expressions that is affecting this clause.
     * </p>
     *
     * @param l
     *            A {@link Location} representation object.
     ...
     * @param whichEntailsExp
     *            A {@link Exp} representing the {@code which_entails} mathematical assertion.
     * @param involvedSharedVars
     *            The list of variable expressions that are listed to be involved in this assertion clause.
     */
    public AssertionClause(Location l, ClauseType type, Exp assertionExp, Exp whichEntailsExp,
            List<Exp> involvedSharedVars) {
        super(l);
    ...
    public final AssertionClause clone() {
        ...
        return new AssertionClause(cloneLocation(), myClauseType, myAssertionExp.clone(), newWhichEntailsExp,
                newInvolvesExp);
    }
    ...
    public final boolean equals(Object o) {
        ...
        if (!myInvolvedSharedVars.equals(that.myInvolvedSharedVars))
            return false;
        return myWhichEntailsExp != null ? myWhichEntailsExp.equals(that.myWhichEntailsExp)
    ...
    /**
     * <p>
     * Returns the list of shared variable expressions that are involved in this clause.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the {@code which_entails} mathematical assertion for this clause.
     * </p>
     *
    ...
    public final int hashCode() {
        ...
        result = 31 * result + (myWhichEntailsExp != null ? myWhichEntailsExp.hashCode() : 0);
        return result;
    }
