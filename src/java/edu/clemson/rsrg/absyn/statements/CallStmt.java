...
/**
 * <p>
 * This is the class for all the call statement objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class CallStmt extends Statement {
     ...
     * @param exp
     *            A {@link ProgramFunctionExp} representing the function we are calling.
     */
    ...
    protected final Statement copy() {
        return new CallStmt(cloneLocation(), (ProgramFunctionExp) myFunctionExp.clone());
    }
