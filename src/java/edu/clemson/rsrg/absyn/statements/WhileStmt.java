...
/**
 * <p>
 * This is the class for all the while loop statement objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class WhileStmt extends Statement {
     ...
     * @param verificationBlock
     *            A {@link LoopVerificationItem} containing the assertions needed for verification purposes.
     * @param statements
     *            The list of {@link Statement}s that are in the while loop.
     */
    public WhileStmt(Location l, ProgramExp test, LoopVerificationItem verificationBlock, List<Statement> statements) {
        super(l);
        myTestingExp = test;
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        sb.append(myVerificationBlock.asString(indentSize + innerIndentInc, innerIndentInc));
        sb.append("\n");
