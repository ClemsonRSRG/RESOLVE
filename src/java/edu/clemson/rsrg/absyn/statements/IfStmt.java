...
/**
 * <p>
 * This is the class for all the {@code if-else} statement objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class IfStmt extends Statement {
     ...
     * @param ifClause
     *            A {@link IfConditionItem} representing if block.
     * @param elseifpairs
     *            A list of {@link IfConditionItem} representing all the else-if pairs.
     * @param elseStatements
     *            The list of {@link Statement}s that are in the else block.
     */
    public IfStmt(Location l, IfConditionItem ifClause, List<IfConditionItem> elseifpairs,
    ...
    /**
     * <p>
     * Implemented by this concrete subclass of {@link Statement} to manufacture a copy of themselves.
     * </p>
     *
    ...
    protected final Statement copy() {
        ...
        return new IfStmt(cloneLocation(), myIfClause.clone(), newElseIfs, newElseStmts);
    }
}
