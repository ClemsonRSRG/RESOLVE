...
/**
 * <p>
 * This is the class for all the facility declaration arguments for Concept/Enhancement modules that the compiler builds
...
public class ModuleArgumentItem extends ResolveConceptualElement {
     ...
     *
     * @param evalExp
     *            A {@link ProgramExp} representing the argument being passed.
     */
    ...
    public final ModuleArgumentItem clone() {
        ModuleArgumentItem newItem = new ModuleArgumentItem(myArgumentExp.clone());
