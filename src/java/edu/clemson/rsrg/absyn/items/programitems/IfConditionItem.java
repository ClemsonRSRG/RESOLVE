...
/**
 * <p>
 * This is the class for all the if/else-if condition block objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class IfConditionItem extends ResolveConceptualElement {
    ...
    /**
     * <p>
     * The list of statements that gets executed if the testing expression is met
     * </p>
     */
    ...
    /**
     * <p>
     * This constructs a if/else-if code block with a condition test. If the testing expression is met, then the code
     * block is executed.
     * </p>
     *
     * @param l
     ...
     * @param test
     *            A {@link ProgramExp} testing expression.
     * @param statements
     *            The list of {@link Statement}s that are in this block.
     */
    public IfConditionItem(Location l, ProgramExp test, List<Statement> statements) {
        super(l);
        myTestingExp = test;
    ...
    public final IfConditionItem clone() {
        return new IfConditionItem(cloneLocation(), myTestingExp.clone(), copyStatements());
    }
    ...
    /**
     * <p>
     * This method returns a deep copy of the list of statements in this code block.
     * </p>
     *
     * @return The list of {@link Statement}s.
     */
