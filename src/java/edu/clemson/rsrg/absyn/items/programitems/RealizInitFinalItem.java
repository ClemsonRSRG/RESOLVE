...
/**
 * <p>
 * This is the class for all the initialization/finalization block objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class RealizInitFinalItem extends AbstractInitFinalItem {
    ...
    /**
     * <p>
     * This constructs a initialization/finalization block that happens when a variable of this type is
     ...
     */
    public RealizInitFinalItem(Location l, ItemType type, AffectsClause affects, List<FacilityDec> facilities,
    ...
    public final RealizInitFinalItem clone() {
        ...
        return new RealizInitFinalItem(cloneLocation(), myItemType, newAffects, copyFacDecs(), copyVars(),
                copyStatements());
    }
