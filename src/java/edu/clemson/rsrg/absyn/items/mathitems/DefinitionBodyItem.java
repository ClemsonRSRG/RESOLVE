...
/**
 * <p>
 * This is the class for all the definition body objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
 */
public class DefinitionBodyItem extends ResolveConceptualElement {
     ...
     *
     * @param base
     *            The base case expression.
     * @param hypothesis
     *            The inductive hypothesis expression.
     */
    ...
    public final DefinitionBodyItem clone() {
        ...
        if (myIsInductiveFlag) {
            newItem = new DefinitionBodyItem(myBase.clone(), myHypothesis.clone());
        } else {
    ...
    public boolean equals(Object o) {
        ...
        if (myBase != null ? !myBase.equals(that.myBase) : that.myBase != null)
            return false;
        if (myHypothesis != null ? !myHypothesis.equals(that.myHypothesis) : that.myHypothesis != null)
            return false;
        return myDefinition != null ? myDefinition.equals(that.myDefinition) : that.myDefinition == null;
    ...
    public final int hashCode() {
        ...
        result = 31 * result + (myHypothesis != null ? myHypothesis.hashCode() : 0);
