...
/**
 * <p>
 * This is the class for all the specification initialization/finalization block objects that the compiler builds using
...
public class SpecInitFinalItem extends ResolveConceptualElement {
     ...
     * @param ensures
     *            A {@link AssertionClause} representing the initialization's/finalization's ensures clause.
     */
    public SpecInitFinalItem(Location l, ItemType type, AffectsClause affects, AssertionClause ensures) {
        super(l);
        myAffects = affects;
        myItemType = type;
        myEnsures = ensures;
    ...
    public final SpecInitFinalItem clone() {
        ...
        return new SpecInitFinalItem(cloneLocation(), myItemType, newAffects, myEnsures.clone());
    }
    ...
    /**
     * <p>
     * This method returns the affects clause in this type initialization/finalization verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the type that indicates if this is an initialization or finalization verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the ensures clause in this type initialization/finalization verification block.
     * </p>
     *
