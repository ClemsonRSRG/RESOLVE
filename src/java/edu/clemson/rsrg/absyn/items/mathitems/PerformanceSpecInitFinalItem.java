...
/**
 * <p>
 * This is the class for all the performance profile's type initialization/finalization verification block objects that
...
public class PerformanceSpecInitFinalItem extends ResolveConceptualElement {
    ...
    /**
     * <p>
     * This constructs a type initialization/finalization block that happens when a variable of this type is
     ...
     * @param duration
     *            A {@link AssertionClause} representing the initialization's/finalization's duration clause.
     * @param manip_disp
     *            A {@link AssertionClause} representing the initialization's/finalization's manipulation displacement
     *            clause.
     */
    public PerformanceSpecInitFinalItem(Location l, ItemType type, AssertionClause duration,
    ...
    public final PerformanceSpecInitFinalItem clone() {
        ...
        return new PerformanceSpecInitFinalItem(cloneLocation(), myItemType, newDuration, newManipDisp);
    }
    ...
    /**
     * <p>
     * This method returns the type that indicates if this is a performance profile's initialization or finalization
     * verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the duration clause in this performance profile's type initialization/finalization
     * verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the manipulation displacement clause in this performance profile's type
