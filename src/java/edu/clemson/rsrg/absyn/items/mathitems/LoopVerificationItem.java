 ...
 */
package edu.clemson.rsrg.absyn.items.mathitems;
...
/**
 * <p>
 * This is the class for all the loop verification block objects that the compiler builds using the ANTLR4 AST nodes.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class LoopVerificationItem extends ResolveConceptualElement {
     ...
     * @param changingVars
     *            The list of program variables that are changing.
     * @param maintaining
     *            The loop invariant.
     * @param decreasing
     *            The termination metric.
     * @param elapsedTime
     *            The total elapsed time for this loop.
     */
    public LoopVerificationItem(Location l, List<ProgramVariableExp> changingVars, AssertionClause maintaining,
    ...
    public final LoopVerificationItem clone() {
        ...
        return new LoopVerificationItem(cloneLocation(), newChangingVars, myMaintainingClause.clone(),
                myDecreasingClause.clone(), newElapsedTimeClause);
    }
    ...
    public final boolean equals(Object o) {
        ...
        if (!myDecreasingClause.equals(that.myDecreasingClause))
            return false;
        return myElapsedTimeClause != null ? myElapsedTimeClause.equals(that.myElapsedTimeClause)
    ...
    /**
     * <p>
     * This method returns the list of changing variables in this loop verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the decreasing clause in this loop verification block.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the elapsed time clause in this loop verification block.
     * </p>
     *
     * @return The {@link AssertionClause} representation object.
     */
    ...
    /**
     * <p>
     * This method returns the maintaining clause in this loop verification block.
     * </p>
     *
     * @return The {@link AssertionClause} representation object.
     */
    ...
    public final int hashCode() {
        ...
        result = 31 * result + (myElapsedTimeClause != null ? myElapsedTimeClause.hashCode() : 0);
        return result;
    }
