...
/**
 * <p>
 * This is the class for all the programming function call expression objects that the compiler builds using the ANTLR4
 * AST nodes.
 * </p>
 *
 * @version 2.0
...
public class ProgramFunctionExp extends ProgramExp {
     ...
     * @param qual
     *            A {@link PosSymbol} representing the expression's qualifier.
     * @param name
     *            A {@link PosSymbol} representing the expression's name.
     * @param arguments
     *            List of arguments for this function call.
     */
    public ProgramFunctionExp(Location l, PosSymbol qual, PosSymbol name, List<ProgramExp> arguments) {
        super(l);
        myQualifier = qual;
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            result = posSymbolEquivalent(myQualifier, eAsProgramFunctionExp.myQualifier)
                    && posSymbolEquivalent(myOperationName, eAsProgramFunctionExp.myOperationName);

            if (myExpressionArgs != null && eAsProgramFunctionExp.myExpressionArgs != null) {
                Iterator<ProgramExp> thisExpArgs = myExpressionArgs.iterator();
                Iterator<ProgramExp> eExpArgs = eAsProgramFunctionExp.myExpressionArgs.iterator();
    ...
    protected final Exp copy() {
        ...
        return new ProgramFunctionExp(cloneLocation(), newQualifier, myOperationName.clone(), copyExps());
    }
