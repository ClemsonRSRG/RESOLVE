...
/**
 * <p>
 * This is the class for all the programming named variable expressions objects that the compiler builds using the
 * ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
...
public class ProgramVariableNameExp extends ProgramVariableExp {
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ProgramVariableNameExp eAsProgramVariableNameExp = (ProgramVariableNameExp) e;

            retval = posSymbolEquivalent(getQualifier(), eAsProgramVariableNameExp.getQualifier())
                    && posSymbolEquivalent(myVarName, eAsProgramVariableNameExp.myVarName);
        }
    ...
    protected final Exp copy() {
        ...
        return new ProgramVariableNameExp(cloneLocation(), newQualifier, myVarName.clone());
    }
