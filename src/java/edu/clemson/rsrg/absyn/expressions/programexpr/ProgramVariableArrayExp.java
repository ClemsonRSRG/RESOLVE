...
public class ProgramVariableArrayExp extends ProgramVariableExp {
     ...
     * @param nameExp
     *            A {@link ProgramVariableExp} representing the expression's name expression.
     * @param indexExp
     *            A {@link ProgramExp} representing the expression's index expression.
     */
    public ProgramVariableArrayExp(Location l, ProgramVariableExp nameExp, ProgramExp indexExp) {
        super(l, null);
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ProgramVariableArrayExp eAsProgramVariableNameExp = (ProgramVariableArrayExp) e;

            retval = myProgramNameExp.equivalent(eAsProgramVariableNameExp.myProgramNameExp)
                    && myProgramIndexExp.equivalent(eAsProgramVariableNameExp.myProgramIndexExp);
        }
    ...
    protected final Exp copy() {
        return new ProgramVariableArrayExp(cloneLocation(), (ProgramVariableExp) myProgramNameExp.clone(),
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        throw new UnsupportedOperationException("Cannot substitute in a program array expression.");
    }
