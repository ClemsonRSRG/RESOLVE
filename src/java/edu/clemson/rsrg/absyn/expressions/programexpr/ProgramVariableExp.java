...
/**
 * <p>
 * This is the abstract base class for all the programming variable expression objects that the compiler builds using
...
public abstract class ProgramVariableExp extends ProgramExp {
    ...
    /**
     * <p>
     * An helper constructor that allow us to store the location and qualifier (if any) of any objects created from a
     * class that inherits from {@code ProgramVariableExp}.
     * </p>
     *
     * @param l
    ...
    public boolean equals(Object o) {
        ...
        return myQualifier != null ? myQualifier.equals(that.myQualifier) : that.myQualifier == null;
    }
