...
/**
 * <p>
 * This is the class for all the mathematical lambda expression objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class LambdaExp extends MathExp {
     ...
     * @param params
     *            A list of {@link MathVarDec} representing the expression's variables.
     * @param body
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            Iterator<MathVarDec> eParameterIterator = eAsLambdaExp.myParameters.iterator();
    ...
    protected final Exp copy() {
        return new LambdaExp(cloneLocation(), copyParameters(), myBodyExp.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        return new LambdaExp(cloneLocation(), copyParameters(), substitute(myBodyExp, substitutions));
    }
    ...
    /**
     * <p>
     * This is a helper method that makes a copy of the list containing all the parameter variables.
     * </p>
     *
