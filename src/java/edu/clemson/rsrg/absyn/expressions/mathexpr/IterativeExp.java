...
/**
 * <p>
 * This is the class for all the mathematical iterative expression objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class IterativeExp extends MathExp {
     ...
     * @param var
     *            A {@link MathVarDec} representing the expression's variable.
     * @param where
     *            A {@link Exp} representing the where clause.
     * @param body
     *            A {@link Exp} representing the body of the expression.
     */
    public IterativeExp(Location l, Operator operator, MathVarDec var, Exp where, Exp body) {
        super(l);
        myOperator = operator;
        myVar = var;
        myWhereExp = where;
    ...
    public final boolean equals(Object o) {
        ...
        if (!myVar.equals(that.myVar))
            return false;
        if (myWhereExp != null ? !myWhereExp.equals(that.myWhereExp) : that.myWhereExp != null)
            return false;
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ...
            retval = myOperator.getOperatorAsPosSymbol(myLoc)
                    .equals(eAsIterativeExp.myOperator.getOperatorAsPosSymbol(myLoc));
    ...
    protected final Exp copy() {
        ...
        return new IterativeExp(cloneLocation(), myOperator, (MathVarDec) myVar.clone(), newWhere, myBodyExp.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        ...
        return new IterativeExp(cloneLocation(), myOperator, (MathVarDec) myVar.clone(), newWhere,
