...
/**
 * <p>
 * This is the class for all the mathematical unary minus expression objects that the compiler builds using the ANTLR4
 * AST nodes.
 * </p>
 *
 * @version 2.0
...
public class UnaryMinusExp extends MathExp {
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        if (myInnerArgumentExp != null) {
            sb.append(myInnerArgumentExp.asString(indentSize + innerIndentInc, innerIndentInc));
        }
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ...
            retval = myInnerArgumentExp.equivalent(eAsUnaryMinusExp.myInnerArgumentExp);
        }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        return new UnaryMinusExp(cloneLocation(), substitute(myInnerArgumentExp, substitutions));
    }
