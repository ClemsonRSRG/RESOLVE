...
/**
 * <p>
 * This is the class for all the mathematical set expression objects of the kind {@code {x : Z | x < y}} that the
...
public class SetExp extends MathExp {
    ...
    public final boolean equals(Object o) {
        ...
        if (!myVar.equals(setExp.myVar))
            return false;
        if (myWhereExp != null ? !myWhereExp.equals(setExp.myWhereExp) : setExp.myWhereExp != null)
            return false;
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ...
            retval = myVar.getName().equals(eAsSetExp.myVar.getName()) && myVar.getTy().equals(eAsSetExp.myVar.getTy());
    ...
    protected final Exp copy() {
        ...
        return new SetExp(cloneLocation(), (MathVarDec) myVar.clone(), newWhere, myBodyExp.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        ...
        return new SetExp(cloneLocation(), (MathVarDec) myVar.clone(), newWhere, substitute(myBodyExp, substitutions));
    }
