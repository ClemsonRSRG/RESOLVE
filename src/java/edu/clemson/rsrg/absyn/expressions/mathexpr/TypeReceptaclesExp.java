...
public class TypeReceptaclesExp extends MathExp {
     ...
     * @param typeNameExp
     *            A {@link VarExp} indicating the type name.
     */
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (e instanceof TypeReceptaclesExp) {
            ...
            retval = (myTypeAsVarExp.equivalent(eAsTypeReceptaclesExp.myTypeAsVarExp));
        }
    ...
    protected final Exp copy() {
        return new TypeReceptaclesExp(cloneLocation(), (VarExp) myTypeAsVarExp.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        return new TypeReceptaclesExp(cloneLocation(), (VarExp) substitute(myTypeAsVarExp, substitutions));
    }
