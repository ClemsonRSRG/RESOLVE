...
/**
 * <p>
 * This is the class for all the mathematical dotted expression objects that the compiler builds using the ANTLR4 AST
 * nodes.
 * </p>
 *
 * @version 2.0
...
public class DotExp extends MathExp {
    ...
    /**
     * <p>
     * This constructs a dotted expression to keep track of all the inner expressions.
     * </p>
     *
     * @param l
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            if (mySegmentExps != null && eAsDotExp.mySegmentExps != null) {
                ...
                while (result && thisSegmentExps.hasNext() && eSegmentExps.hasNext()) {

                    result &= thisSegmentExps.next().equivalent(eSegmentExps.next());
                }

                // Both had better have run out at the same time
                result &= (!thisSegmentExps.hasNext()) && (!eSegmentExps.hasNext());
            }
        }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        ...
        if (!mySegmentExps.isEmpty()) {
            ...
            if (substitutionKey == null) {
                ...
                else if (replacementExp instanceof VCVarExp && (lastGoodIndex + 1 == mySegmentExps.size())) {
