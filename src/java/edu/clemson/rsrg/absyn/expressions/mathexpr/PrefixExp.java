...
/**
 * <p>
 * This is the abstract base class for all the mathematical prefix expression objects that the compiler builds using the
 * ANTLR4 AST nodes.
 * </p>
 *
 * @version 2.0
...
public class PrefixExp extends AbstractFunctionExp {
     ...
     */
    public PrefixExp(Location l, PosSymbol opQual, PosSymbol opName, Exp argument) {
        super(l, opQual);
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (retval) {
            ...
            retval = Exp.posSymbolEquivalent(myOperationName, eAsPrefixExp.myOperationName)
    ...
    protected final Exp copy() {
        ...
        return new PrefixExp(cloneLocation(), qualifier, myOperationName.clone(), myArgument.clone());
    }
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        ...
        return new PrefixExp(cloneLocation(), qualifier, myOperationName.clone(),
