...
/**
 * <p>
 * This is the class for all the mathematical alternative expression objects that the compiler builds using the ANTLR4
 * AST nodes.
 * </p>
 *
 * @version 2.0
...
public class AlternativeExp extends MathExp {
     ...
     * @param alternatives
     *            A list of {@link AltItemExp} expressions.
     */
    public AlternativeExp(Location l, List<AltItemExp> alternatives) {
        ...
        if (!foundOtherwise) {
            throw new MiscErrorException("Must have otherwise.", new IllegalArgumentException());
        }
    }
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        if (myAlternatives != null) {
            for (AltItemExp exp : myAlternatives) {
                if (exp != null) {
                    sb.append("\n");
                    sb.append(exp.asString(indentSize + innerIndentInc + innerIndentInc, innerIndentInc));
                }
            }
        }
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            Iterator<AltItemExp> eAltItems = eAsAlternativeExp.myAlternatives.iterator();
    ...
    /**
     * <p>
     * This is a helper method that makes a copy of the list of alternative expressions.
     * </p>
     *
     * @return A list containing {@link AltItemExp}s.
     */
