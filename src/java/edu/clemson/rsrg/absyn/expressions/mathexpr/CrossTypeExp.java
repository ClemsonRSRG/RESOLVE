...
public class CrossTypeExp extends MathExp {
     ...
     * @param tagsToFieldsMap
     *            A map containing all the tags to fields mapping.
     */
    public CrossTypeExp(Location l, Map<PosSymbol, ArbitraryExpTy> tagsToFieldsMap) {
        super(l);
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        for (PosSymbol tag : tags) {
            sb.append(tag.asString(indentSize + 2 * innerIndentInc, innerIndentInc));
            sb.append(": ");
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            while (result && thisTagsIt.hasNext() && eTagsIt.hasNext()) {
                ...
                ArbitraryExpTy eTy = eAsCrossTypeExp.myTagsToFields.get(eTagsIt.next());
                result &= thisTy.getArbitraryExp().equivalent(eTy.getArbitraryExp());
            }
