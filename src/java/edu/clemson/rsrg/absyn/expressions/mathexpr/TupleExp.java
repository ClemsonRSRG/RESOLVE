 ...
 * how would we pass it its parameters if not via a tuple? Thus, TupleExp is a built-in notion, and not imagined as the
...
public class TupleExp extends MathExp {
    ...
    /**
     * <p>
     * This constructs a tuple expression that contains exactly two elements per field.
     * </p>
     *
     * @param l
    ...
    public final boolean equivalent(Exp e) {
        ...
        if (result) {
            ...
            if (myFields != null && eAsTupleExp.myFields != null) {
                ...
                while (result && thisFieldExps.hasNext() && eFieldExps.hasNext()) {

                    result &= thisFieldExps.next().equivalent(eFieldExps.next());
                }
     ...
     *
     * @param index
     *            The index of the field expression.
     *
    ...
    public final Exp getField(int index) {
        ...
        if (index < 0 || index >= mySize) {
            throw new MiscErrorException("Index out of bounds.", new IndexOutOfBoundsException("" + index));
        }
    ...
    /**
     * <p>
     * This method checks to see if all the field expressions inside this tuple expression are universally quantified.
     * </p>
     *
     * @return {@code true} if all {@link Exp}s are universally quantified, {@code false} otherwise.
     */
    public final boolean isUniversallyQuantified() {
        ...
        for (Exp field : myFields) {
            soFar = soFar && ((field instanceof VarExp
                    && ((VarExp) field).getQuantification() == SymbolTableEntry.Quantification.UNIVERSAL)
                    || (field instanceof TupleExp && ((TupleExp) field).isUniversallyQuantified()));
        }
    ...
    /**
     * <p>
     * This is a helper method that makes a copy of the list containing all the field expressions.
     * </p>
     *
