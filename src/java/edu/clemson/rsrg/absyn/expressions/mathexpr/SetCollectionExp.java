...
/**
 * <p>
 * This is the class for all the mathematical set (as a collection) expression objects that the compiler builds using
...
public class SetCollectionExp extends MathExp {
     ...
     * @param vars
     *            A set of {@link MathExp}s where each one is a member in this set.
     */
        ...
        if (result) {
            ...
            if (myMembers != null && eAsSetCollectionExp.myMembers != null
                ...
                while (result && thisMemberExps.hasNext()) {
                    ...
                    boolean found = false;
                    Iterator<MathExp> eMemberExps = eAsSetCollectionExp.myMembers.iterator();
    ...
    /**
     * <p>
     * This is a helper method that makes a copy of the list containing all the variable expressions.
     * </p>
     *
