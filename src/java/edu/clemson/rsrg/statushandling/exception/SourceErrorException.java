...
public class SourceErrorException extends CompilerException {
    ...
    /**
     * <p>
     * This constructor takes in a throwable cause and a message for the symbol that caused an source exception to be
     * thrown.
     * </p>
     *
     * @param message
    ...
    /**
     * <p>
     * This constructor takes in a message for the symbol that caused an source exception to be thrown.
     * </p>
     *
     * @param message
     *            Message to be displayed when the exception is thrown.
    ...
    /**
     * <p>
     * This constructor takes in a message for the location that caused an source exception to be thrown.
     * </p>
     *
     * @param message
     *            Message to be displayed when the exception is thrown.
    ...
    /**
     * <p>
     * This constructor takes in a throwable cause and a message for the location that caused an source exception to be
     * thrown.
     * </p>
     *
     * @param message
