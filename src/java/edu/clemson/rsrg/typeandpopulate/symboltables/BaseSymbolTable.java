...
/**
 * <p>
 * An helper class to factor out some logic repeated in {@link ScopeBuilder} and {@link Scope} and remove the temptation
 * to muck about with the entry map directly.
 * </p>
 *
 * @version 2.0
 */
class BaseSymbolTable implements SymbolTable {
     ...
     *
     * @param source
     *            An existing source {@code BaseSymbolTable}.
     */
