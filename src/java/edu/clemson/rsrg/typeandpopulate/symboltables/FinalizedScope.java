...
public class FinalizedScope extends SyntacticScope {
     ...
     */
    FinalizedScope(MathSymbolTable symbolTable, ResolveConceptualElement definingElement, Scope parent,
            ModuleIdentifier enclosingModule, BaseSymbolTable bindings) {
        super(symbolTable, definingElement, parent, enclosingModule, new BaseSymbolTable(bindings));
    }
