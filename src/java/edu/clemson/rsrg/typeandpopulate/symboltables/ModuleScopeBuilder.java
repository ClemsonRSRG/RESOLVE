...
/**
 * <p>
 * A <code>ModuleScopeBuilder</code> refines {@link ScopeBuilder} with additional information specific to modules, such
 * as a list of imports.
 * </p>
 *
 * @version 2.0
 */
public class ModuleScopeBuilder extends ScopeBuilder implements ModuleScope {
     ...
     */
    ModuleScopeBuilder(TypeGraph g, ModuleDec definingElement, Scope parent, MathSymbolTableBuilder symbolTable) {
    ...
    /**
     * <p>
     * Adds <code>i</code> to the list of modules imported by the module who's scope this
     * <code>ModuleScopeBuilder</code> represents. Duplicate imports or attempting to import the module represented
     * itself will leave the import list unmodified.
     * </p>
     *
     * @param i
    ...
    /**
     * <p>
     * Returns a <code>ModuleDec</code> who's scope is represented by this <code>ModuleScope</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns a <code>List</code> of modules that the module who's scope is represented by this
     * <code>ModuleScope</code> imports, not including itself (which all modules are defined to import). This
     * <code>List</code> is a copy and modifying it will not impact the behavior of this <code>ModuleScope</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns a <code>ModuleIdentifier</code> that can be used to refer to the module who's scope is represented by
     * this <code>ModuleScope</code>.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns <code>true</code> <strong>iff</strong> the module who's scope is represented by this
     * <code>ModuleScope</code> imports the given module. Note that, by definition, all modules import themselves.
     * </p>
     *
    ...
    final FinalizedModuleScope seal(MathSymbolTable finalTable) {
        return new FinalizedModuleScope(finalTable, myDefiningElement, myParent, myRootModule, myBindings,
                myImportedModules);
    }
