...
public class MathSymbolTable extends ScopeRepository {
    ...
    public enum FacilityStrategy {
         ...
         * used by symbols inside the facility should be updated to reflect the particular instantiation of the generic
         * types.
         * </p>
         */
        ...
        /**
         * <p>
         * Indicates that available facilities should be searched with generic types intact. That is, any types used by
         * symbols inside the facility will appear exactly as listed in the source file--including references to
     ...
     * addition to those scopes directly imported in the <em>uses</em> clause, any modules implicitly imported will also
     * be searched. Implicitly imported modules include the standard modules (<code>Std_Boolean_Fac</code>, etc.), and
     * any modules named in the header of the source module (e.g., an enhancement realization implicitly imports it's
    ...
    public enum ImportStrategy {
        ...
        IMPORT_NONE {
             ...
             * </p>
             *
             * @return The strategy that should be used to recursively search any imported modules.
             */
            @Override
            ...
            /**
             * <p>
             * Returns <code>true</code> <strong>iff</strong> this strategy requires searching directly imported
             * modules.
             * </p>
             *
             * @return <code>true</code> <strong>iff</strong> this strategy requires searching directly imported
             *         modules.
             */
            @Override
        ...
        /**
         * <p>
         * Returns <code>true</code> <strong>iff</strong> this strategy requires searching directly imported modules.
         * </p>
         *
         * @return <code>true</code> <strong>iff</strong> this strategy requires searching directly imported modules.
         */
    ...
    /**
     * <p>
     * A map of non-module scopes.
     * </p>
     */
    private final Map<ResolveConceptualElement, FinalizedScope> myScopes = new HashMap<>();

    /**
     * <p>
     * A map of module scopes
     * </p>
     */
    private final Map<ModuleIdentifier, FinalizedModuleScope> myModuleScopes = new HashMap<>();
    ...
    /**
     * <p>
     * This constructs a mathematical symbol table.
     * </p>
     *
     * @param g
     *            The current type graph.
     ...
     *             Throws an error if we cannot locate the requested imported module from the source module.
     */
    MathSymbolTable(TypeGraph g, ScopeBuilder root) throws NoSuchModuleException {
        myTypeGraph = g;
     ...
     */
    @Override
    public final ModuleScope getModuleScope(ModuleIdentifier module) throws NoSuchScopeException {
    ...
    /**
     * <p>
     * This creates an {@link ImportRequest} for each imported module.
     * </p>
     *
     * @param source
     *            The source module's identifier.
     * @param imports
     *            The list of modules imported by <code>source</code>.
     *
    ...
    /**
     * <p>
     * This method makes sure that we do not attempt to import more modules after we invoke the constructor.
     * </p>
     *
     * @param b
     *            The current scope repository builder.
    ...
    private void seal(ScopeBuilder b, List<ImportRequest> importedModules) {
        ...
        if (definingElement != null) {
            ...
            if (result instanceof FinalizedModuleScope) {
                ...
                importedModules.addAll(buildImportRequests(resultIdentifier, resultAsModuleScope.getImports()));
            }
        }
    ...
    /**
     * <p>
     * An helper construct that keeps track of both {@link ModuleIdentifier} for the source and imported modules.
     * </p>
     */
    private static class ImportRequest {
        ...
        /**
         * <p>
         * This creates a helper construct that keeps track of imported module for the specified source module.
         * </p>
         *
         * @param source
         *            The source module's identifier.
         * @param imported
         *            The imported module's identifier.
         */
