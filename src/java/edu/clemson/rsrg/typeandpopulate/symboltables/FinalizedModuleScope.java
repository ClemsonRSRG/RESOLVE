...
class FinalizedModuleScope extends FinalizedScope implements ModuleScope {
     ...
     *            The list of modules imported by this {@link ModuleDec}.
     */
    FinalizedModuleScope(MathSymbolTable source, ResolveConceptualElement definingElement, Scope parent,
            ModuleIdentifier enclosingModule, BaseSymbolTable bindings, List<ModuleIdentifier> importedModules) {
    ...
    /**
     * <p>
     * Returns <code>true</code> <strong>iff</code> the module who's scope is represented by this
