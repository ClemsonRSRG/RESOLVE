...
public class MTCartesian extends MTAbstract<MTCartesian> {
    ...
    /**
     * <p>
     * This constructs a Cartesian type with {@link Element}s that will be in this type.
     * </p>
     *
     * @param g
     *            The current type graph.
     * @param elements
     *            The {@link Element}s that are in this Cartesian type.
     */
    ...
    /**
     * <p>
     * This constructs a Cartesian type with a list of {@link Element}s that will be in this type.
     * </p>
     *
     * @param g
     *            The current type graph.
     * @param elements
     *            A list of {@link Element}s that are in this Cartesian type.
     */
    ...
    /**
     * <p>
     * This constructs a Cartesian type with an array of {@link Element}s of this type with an element counter.
     * </p>
     *
     * @param g
     *            The current type graph
     * @param elements
     *            An array of {@link Element}s that are in this Cartesian type.
     * @param elementCount
     *            The number of elements in this type.
     */
     ...
     *            An index.
     *
     * @return The type corresponding to the {@link Element} specified by the index.
     */
    ...
    /**
     * <p>
     * This method returns the {@link MTType} associated with the specified string.
     * </p>
     *
     * @param tag
     *            A string corresponding to one of the {@link Element}s.
     *
    ...
    /**
     * <p>
     * This method returns the symbol representation of the {@link Element} at the specified index.
     * </p>
     *
     * @param index
     *            An index.
     ...
     *
     * @return A new {@link MTCartesian} with the type at the specified index replaced with {@code newType}.
     */
    @Override
    ...
    /**
     * <p>
     * This helper class allow us to store a name for an element in the Cartesian type and the type for the element.
     * </p>
     *
     * @version 2.0
     */
    public static class Element {
         ...
         *
         * @param elements
         *            Original list of {@link Element}s.
         * @param elementTypes
         *            Original list of {@link MTType}s.
         * @param tagsToElements
         *            A map contains a mapping of strings to {@link Element}s that needs to be updated.
         * @param elementsToTags
         *            A map contains a mapping of strings to {@link MTType}s that needs to be updated.
         */
        private void addTo(List<Element> elements, List<MTType> elementTypes, Map<String, Element> tagsToElements,
