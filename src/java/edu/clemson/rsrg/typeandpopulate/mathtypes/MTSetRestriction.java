...
/**
 * <p>
 * An set restriction type that is restricted to an {@link Exp}.
 * </p>
 *
 * @version 2.0
 */
public class MTSetRestriction extends MTAbstract<MTSetRestriction> {
    ...
    /**
     * <p>
     * The variable representing an element of the set.
     * </p>
     */
    ...
    /**
     * <p>
     * The restriction condition expression.
     * </p>
     */
    ...
    /**
     * <p>
     * This constructs a set restriction type for a base type, a variable that represents an element of the set and the
     * restriction condition expression.
     * </p>
     *
     * @param g
     *            The current type graph.
     * @param baseType
     *            The {@link MTType} to be restricted.
     * @param setVar
     *            A string that represents an element in the set.
     * @param restriction
     *            The restriction condition expression.
     */
    ...
    /**
     * <p>
     * This method returns a list of containing the base {@link MTType} for this type.
     * </p>
     *
     ...
     *
     * @return A new {@link MTSetRestriction} with the type at the specified index replaced with {@code newType}.
     */
    @Override
