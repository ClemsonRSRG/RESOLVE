...
/**
 * <p>
 * Represents a type that is simply a named reference to some bound variable. For example, in
...
public class MTNamed extends MTType {
     ...
     * </p>
     *
     * @return An empty list, because {@link MTNamed} cannot contain component types.
     */
    @Override
    ...
    /**
     * <p>
     * This method takes a map of original types and converts it to a map of {@code MTNamed} types.
     * </p>
     *
     * @param source
     *            The current type graph.
     * @param original
     *            Original map of {@link MTType}s.
     *
     ...
     *
     * @return This method will always throw an {@link IndexOutOfBoundsException}, since {@link MTNamed} cannot contain
     *         component types.
     */
    @Override
