...
/**
 * <p>
 * Represents a <em>type family</em> as would be introduced inside a concept. This is an abstract program type without a
 * realization and without parameters instantiated.
 * </p>
 *
 * @version 2.0
 */
public class PTFamily extends PTType {
    ...
    /**
     * <p>
     * Exemplar associated with this type.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates a program type using a type family.
     * </p>
     *
     * @param model
     *            The type family's mathematical model.
     * @param familyName
     *            The type family's name.
     * @param exemplarName
     *            The type family's exemplar name.
     */
    ...
    public final boolean equals(Object o) {
        ...
        if (result) {
            ...
            result = (myModel.equals(oAsPTFamily.myModel)) && (myName.equals(oAsPTFamily.myName))
    ...
    /**
     * <p>
     * This method returns the exemplar name associated with this type.
     * </p>
     *
     * @return A string.
     */
