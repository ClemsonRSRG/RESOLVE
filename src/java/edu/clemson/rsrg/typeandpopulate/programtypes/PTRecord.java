...
import edu.clemson.rsrg.typeandpopulate.mathtypes.MTCartesian.Element;
...
/**
 * <p>
 * A {@code PTRecord} is record of variables with {@link PTInstantiated} types or from {@link PTGeneric} types from the
 * specification field that is used to implement a {@link PTFamily}. The record itself should be a
 * {@link PTInstantiated} object.
 * </p>
 *
 * @version 2.0
 */
public class PTRecord extends PTInstantiated {
     ...
     * @param types
     *            A map of all programming types in this record.
     */
