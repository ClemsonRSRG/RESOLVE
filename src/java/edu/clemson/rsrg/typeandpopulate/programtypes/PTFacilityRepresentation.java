...
/**
 * <p>
 * A <code>PTFacilityRepresentation</code> is similar to a {@link PTRepresentation}, but doesn't implement a
 * {@link PTFamily}. An instance of <code>PTFacilityRepresentation</code> is thus a special case of its wrapped type
 * that happens to be functioning as a representation type.
 * </p>
 *
 * @version 2.0
 */
public class PTFacilityRepresentation extends PTType {
    ...
    /**
     * <p>
     * Since facility representation types do not have a corresponding <code>PTFamily</code>, we just store the name
     * they go by here.
     * </p>
     */
     ...
     *            This type's name.
     */
    public PTFacilityRepresentation(TypeGraph g, PTInstantiated baseType, String typeName) {
        super(g);
        myBaseType = baseType;
        myName = typeName;
    }
