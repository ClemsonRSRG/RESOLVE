...
/**
 * <p>
 * A <code>NameQuery</code> takes a (possibly-null) qualifier and a name and searches for entries that match. If the
 * qualifier is non-null, the appropriate facility or module is searched. If it <em>is</em> null, a search is performed
 * using the provided <code>ImportStrategy</code> and <code>FacilityStrategy</code>.
 * </p>
 *
 * @version 2.0
 */
public class NameQuery extends BaseMultimatchSymbolQuery<SymbolTableEntry> {
     ...
     */
    public NameQuery(PosSymbol qualifier, String name, ImportStrategy importStrategy, FacilityStrategy facilityStrategy,
    ...
    /**
     * <p>
     * This query searches for all entries that match the given name represented as a {@link PosSymbol}.
     * </p>
     *
     * @param qualifier
     *            A qualifier symbol that indicates the instantiating facility or module.
    ...
    /**
     * <p>
     * This query searches for all entries that match the given name using no import or facility strategies and no local
     * priority.
     * </p>
     *
     * @param qualifier
    ...
    /**
     * <p>
     * This query searches for all entries that match the given name represented as a {@link PosSymbol} using no import
     * or facility strategies and no local priority.
     * </p>
     *
     * @param qualifier
     *            A qualifier symbol that indicates the instantiating facility or module.
