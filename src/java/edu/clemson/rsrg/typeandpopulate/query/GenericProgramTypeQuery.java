...
import edu.clemson.rsrg.typeandpopulate.query.searcher.GenericProgramTypeSearcher;
...
/**
 * <p>
 * A <code>GenericProgramTypeQuery</code> returns all {@link ProgramTypeEntry} in our current scope. The search is
 * performed using {@link ImportStrategy#IMPORT_NAMED} and {@link FacilityStrategy#FACILITY_IGNORE} using the
 * {@link GenericProgramTypeSearcher#INSTANCE}.
 * </p>
 *
 * @version 2.0
 */
public class GenericProgramTypeQuery extends BaseMultimatchSymbolQuery<ProgramTypeEntry> {
     ...
     * </p>
     */
    public static final GenericProgramTypeQuery INSTANCE = new GenericProgramTypeQuery();
