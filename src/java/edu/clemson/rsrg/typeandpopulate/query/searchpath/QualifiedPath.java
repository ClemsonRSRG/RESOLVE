...
public class QualifiedPath implements ScopeSearchPath {
    ...
    public final <E extends SymbolTableEntry> List<E> searchFromContext(TableSearcher<E> searcher, Scope source,
        ...
        try {
            ...
            FacilityEntry facility = source.queryForOne(new UnqualifiedNameQuery(myQualifier.getName()))
            ...
            if (result.size() == 0) {
                ...
                for (ModuleParameterization facEnh : enhancementList) {
                    ...
                    // Search for matches
                    tempResult = facilityScope.getMatches(searcher, SearchContext.FACILITY);
                    ...
                    if (tempResult.size() != 0) {
                        if (result.size() == 0) {
                            ...
                            // Found more than one
                            throw new DuplicateSymbolException("Found two matching entries!", result.get(1));
                        }
                    }
                }
            }
            ...
            try {
                ...
                throw new SourceErrorException("No such facility or a module: " + myQualifier.getName(),
