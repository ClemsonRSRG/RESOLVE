...
/**
 * <p>
 * This class attempts to figure out either to use {@link QualifiedPath} when a symbol is fully qualified or use
 * {@link UnqualifiedPath} when it is not.
 * </p>
 *
 * @version 2.0
 */
public class PossiblyQualifiedPath implements ScopeSearchPath {
     ...
     */
    public PossiblyQualifiedPath(PosSymbol qualifier, ImportStrategy importStrategy, FacilityStrategy facilityStrategy,
    ...
    /**
     * <p>
     * A static helper method that helps this class decide either to use a {@link QualifiedPath} or a
