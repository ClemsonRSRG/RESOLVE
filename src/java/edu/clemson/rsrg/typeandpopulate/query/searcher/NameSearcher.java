...
/**
 * <p>
 * A <code>NameSearcher</code> returns entries in a {@link SymbolTable} that have the specified name.
 * </p>
 *
 * @version 2.0
 */
public class NameSearcher implements MultimatchTableSearcher<SymbolTableEntry> {
    ...
    /**
     * <p>
     * This constructs a searcher that specifies a search string and a boolean flag that indicates whether or not we
    ...
    /**
     * <p>
     * This constructs a searcher that specifies a search string and stops after we locate the first match.
     * </p>
     *
     * @param searchString
     *            Name of the entry to be searched.
