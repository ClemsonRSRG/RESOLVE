...
/**
 * <p>
 * An <code>EntryTypeSearcher</code> returns entries in a {@link SymbolTable} that have the specified entry type.
 * </p>
 *
 * @param <E>
 *            The return type of the base <code>MultimatchTableSearcher</code>.
 *
 * @version 2.0
 */
public class EntryTypeSearcher<E extends SymbolTableEntry> implements MultimatchTableSearcher<E> {
    ...
    /**
     * <p>
     * An {@code EntryTypeSearcher} for {@link FacilityEntry}s.
     * </p>
     */
    public static final EntryTypeSearcher<FacilityEntry> FACILITY_SEARCHER = new EntryTypeSearcher<>(
            FacilityEntry.class);
    ...
    /**
     * <p>
     * This constructs a searcher that specifies an symbol table entry type.
     * </p>
     *
     * @param targetClass
     *            A class that inherits from {@link SymbolTableEntry}.
