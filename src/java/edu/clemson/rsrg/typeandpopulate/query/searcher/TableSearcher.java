...
/**
 * <p>
 * A <code>TableSearcher</code> is a strategy for searching a {@link SymbolTable}, adding any {@link SymbolTableEntry}s
 * that match the search to an accumulator.
 * </p>
 *
 * @param <E>
 *            Permits concrete implementations of this interface to refine the type of <code>SymbolTableEntry</code>
 *            they will match. This searcher guarantees that any entry it matches will descend from <code>E</code>. Put
 *            another way: no matched entry will not be a subtype of <code>E</code>.
 *
 * @version 2.0
 */
public interface TableSearcher<E extends SymbolTableEntry> {
    ...
    /**
     * <p>
     * This enumerates the distinct types of search context.
     * </p>
     */
    enum SearchContext {
     ...
     */
    boolean addMatches(SymbolTable entries, List<E> matches, SearchContext l) throws DuplicateSymbolException;
