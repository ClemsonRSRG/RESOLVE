...
/**
 * <p>
 * A <code>NameAndEntryTypeSearcher</code> returns entries in a {@link SymbolTable} that have the specified name and
 * entry type.
 * </p>
 *
 * @param <E>
...
public class NameAndEntryTypeSearcher<E extends SymbolTableEntry> implements MultimatchTableSearcher<E> {
    ...
    /**
     * <p>
     * This constructs a searcher that specifies a search string, an entry type and a boolean flag that indicates
