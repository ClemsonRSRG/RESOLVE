...
import edu.clemson.rsrg.typeandpopulate.query.searcher.MultimatchTableSearcher;
...
/**
 * <p>
 * A <code>UniversalVariableQuery</code> searches for entries that are universally quantified.
 * </p>
 *
 * @version 2.0
 */
public class UniversalVariableQuery implements MultimatchSymbolQuery<MathSymbolEntry> {
     ...
     * </p>
     */
    public static final MultimatchSymbolQuery<MathSymbolEntry> INSTANCE = new UniversalVariableQuery();
    ...
    /**
     * <p>
     * This query searches for all {@link MathSymbolEntry} that are universally quantified.
     * </p>
     */
    private UniversalVariableQuery() {
        myBaseQuery = new SimpleMultimatchSymbolQuery(
                new UnqualifiedPath(ImportStrategy.IMPORT_NONE, FacilityStrategy.FACILITY_IGNORE, false),
     ...
     * </p>
     */
    private static class SimpleMultimatchSymbolQuery extends BaseMultimatchSymbolQuery<MathSymbolEntry> {
        ...
        /**
         * <p>
         * This query searches for all {@link MathSymbolEntry} that using a {@link MultimatchTableSearcher}.
         * </p>
         */
        SimpleMultimatchSymbolQuery(ScopeSearchPath path, MultimatchTableSearcher<MathSymbolEntry> searcher) {
            super(path, searcher);
        }
    ...
    /**
     * <p>
     * This is an implementation of {@link MultimatchTableSearcher} for searching universally quantified symbol table
     * entries.
     * </p>
     */
    private static class UniversalVariableSearcher implements MultimatchTableSearcher<MathSymbolEntry> {
        ...
        /**
         * <p>
         * Refines {@link TableSearcher#addMatches(SymbolTable, List, SearchContext)}} to guarantee that it will not
         * throw a {@link DuplicateSymbolException}. Otherwise, behaves identically.
         * </p>
         *
         * @param entries
         ...
         *
         * @return <code>true</code> if <code>matches</code> now represents a final list of search results; i.e., no
         *         further symbol table entries should be considered. <code>false</code> indicates that the search
         *         should continue, provided there are additional un-searched scopes.
         */
        @Override
        public final boolean addMatches(SymbolTable entries, List<MathSymbolEntry> matches, SearchContext l) {
