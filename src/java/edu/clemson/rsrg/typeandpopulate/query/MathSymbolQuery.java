...
public class MathSymbolQuery extends ResultProcessingQuery<SymbolTableEntry, MathSymbolEntry> {
    ...
    public MathSymbolQuery(PosSymbol qualifier, String name, Location nameLoc) {
        super(new SimpleSymbolQuery(new PossiblyQualifiedPath(qualifier, ImportStrategy.IMPORT_NAMED,
                FacilityStrategy.FACILITY_INSTANTIATE, true), new NameSearcher(name, true)),
    ...
    /**
     * <p>
     * This is an implementation of a {@link Mapping} between {@link SymbolTableEntry} and {@link MathSymbolEntry}.
     * </p>
     */
    private static class MapToMathSymbol implements Mapping<SymbolTableEntry, MathSymbolEntry> {
        ...
        /**
         * <p>
         * This creates a conversion mapping between {@link SymbolTableEntry} and {@link MathSymbolEntry}.
         * </p>
         *
         * @param l
         *            Location for the name.
        ...
        /**
         * <p>
         * This method converts a {@link SymbolTableEntry} into a {@link MathSymbolEntry}.
         * </p>
         *
         * @param input
