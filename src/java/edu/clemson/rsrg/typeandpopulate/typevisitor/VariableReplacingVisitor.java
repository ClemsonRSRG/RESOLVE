...
/**
 * <p>
 * This class visits the named types to see if any of the given names needs to be replaced.
 * </p>
 *
 * @version 2.0
 */
public class VariableReplacingVisitor extends MutatingVisitor {
    ...
    /**
     * <p>
     * This constructs a visitor used to replace all variable that are provided in the map.
     * </p>
     *
     * @param substitutions
     *            A map of substitution types as strings.
     * @param g
    ...
    /**
     * <p>
     * This method adds additional logic after we visit a {@link MTNamed} by replacing it with the {@link MTType} with
     * the changes provided by the map.
     * </p>
     *
     * @param t
     *            A math type.
