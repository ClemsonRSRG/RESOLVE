...
/**
 * <p>
 * This class attempts to bind the concrete expression <code>t1</code> against the template expression <code>t2</code>.
 * </p>
 *
 * @version 2.0
 */
public class BindingVisitor extends SymmetricBoundVariableVisitor {
    ...
    /**
     * <p>
     * This constructs a visitor with the type graph, a bounded variable map and a template variable map.
     * </p>
     *
     * @param g
     *            The current type graph.
    ...
    /**
     * <p>
     * This method adds additional logic before we visit two {@link MTNamed} by attempting to bind <code>t1</code> to
     * <code>t2</code>.
     * </p>
     *
     * @param t1
    ...
    /**
     * <p>
     * This method adds additional logic before we visit two {@link MTProper} by checking if <code>t1</code> is equal to
     * <code>t2</code>.
     * </p>
     *
     * @param t1
    ...
    /**
     * <p>
     * This method returns the current final binding result between two {@link MTType MTTypes}.
     * </p>
     *
     * @return {@code true} if we have successfully bound <code>t1</code> to <code>t2</code>, {@code false} otherwise.
     */
