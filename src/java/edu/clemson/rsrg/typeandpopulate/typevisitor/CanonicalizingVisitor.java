...
import edu.clemson.rsrg.typeandpopulate.mathtypes.MTBigUnion;
import edu.clemson.rsrg.typeandpopulate.mathtypes.MTNamed;
...
import edu.clemson.rsrg.typeandpopulate.typereasoning.relationships.IsInPredicate;
import edu.clemson.rsrg.typeandpopulate.typereasoning.relationships.TypeRelationshipPredicate;
import java.util.*;

/**
 * <p>
 * This class visits the named types to see if any of the given names needs to be replaced with their canonical names.
 * </p>
 *
 * @version 2.0
 */
public class CanonicalizingVisitor extends MutatingVisitor {
    ...
    /**
     * <p>
     * This constructs a visitor used to replace all names to their canonical forms.
     * </p>
     *
     * @param g
    ...
    /**
     * <p>
     * This method adds additional logic before we visit a {@link MTNamed} by replacing all canonical types in
     * <code>t</code>.
     * </p>
     *
     * @param t
    ...
    public final void beginMTNamed(MTNamed t) {
        ...
        try {
            ...
            try {
                ...
                if (entry.getQuantification().equals(SymbolTableEntry.Quantification.UNIVERSAL)) {
                    ...
                    myCanonicalToEnvironmentOriginal.put(canonicalName + myPredicateSuffix, t.getName());
                }
        ...
        if (originalBinding != null) {
            ...
            MTNamed lastReplace = (MTNamed) getInnermostBindingAnnotation(t.getName(), "LastReplace");

            if (lastReplace != null) {
                myPredicates.add(new EqualsPredicate(myTypeGraph, lastReplace, canonicalTypeWithSuffix));
            }
            annotateInnermostBinding(t.getName(), "LastReplace", canonicalTypeWithSuffix);
    ...
    /**
     * <p>
     * This method returns the list of type relationships that we have encountered/formed.
     * </p>
     *
        ...
        for (String var : t.getQuantifiedVariables().keySet()) {
            ...
            if (lastReplace == null) {
                ...
                throw new IllegalArgumentException(
                        "Universal type variable " + "\"" + var + "\" is not concretely bound.");
            }
        }
    ...
    /**
     * <p>
     * This method returns the inner most binding object for the given variable name and key.
     * </p>
     *
     * @param name
     *            A variable name.
    ...
    /**
     * <p>
     * This method adds additional logic to mutate a {@code t} after we visit it.
     * </p>
     *
     * @param t
     *            A math type.
