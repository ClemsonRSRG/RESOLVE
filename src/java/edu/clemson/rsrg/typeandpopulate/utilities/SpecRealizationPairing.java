...
/**
 * <p>
 * A <code>SpecRealizationPairing</code> pairs both a specification and a realization together to indicate that the
 * realization implements the given specification.
 * </p>
 *
 * @version 2.0
 */
public class SpecRealizationPairing {
     ...
     *            Realization parameter object.
     */
    public SpecRealizationPairing(Location l, ModuleParameterization spec, ModuleParameterization realization) {
        if (spec == null) {
     ...
     * </p>
     *
     * @return A {@link ModuleParameterization} object that refers either to a {@link ConceptRealizModuleDec} or a
     *         {@link EnhancementRealizModuleDec}.
     */
    public final ModuleParameterization getRealization() throws NoneProvidedException {
     ...
     * </p>
     *
     * @return A {@link ModuleParameterization} object that refers either to a {@link ConceptModuleDec} or a
     *         {@link EnhancementModuleDec}.
     */
