...
import edu.clemson.rsrg.typeandpopulate.symboltables.InstantiatedScope;
...
/**
 * <p>
 * A <code>ModuleParameterization</code> is part of a facility declaration where it is using a spec
...
public class ModuleParameterization {
    ...
    /**
     * <p>
     * This method returns the module identifier for the module that this object refers to.
     * </p>
     *
     ...
     *
     * @param instantiated
     *            Boolean flag to indicate whether or not this object has been instantiated.
     *
     * @return An {@link InstantiatedScope} with either the generic parameters or instantiated version of the
     *         parameters.
     */
        ...
        try {
            ...
            if (instantiated) {
                ...
                if (originalScope.getDefiningElement() instanceof EnhancementModuleDec) {
                    ModuleParameterization conceptParameterization = myInstantiatingFacility.getFacility()
                            .getSpecification();
                    ModuleIdentifier conceptID = conceptParameterization.getModuleIdentifier();
                    ModuleScope conceptScope = mySourceRepository.getModuleScope(conceptID);
                    genericInstantiations = getGenericInstantiations(conceptScope,
                            conceptParameterization.getParameters());
                } else {
                    genericInstantiations = getGenericInstantiations(originalScope, myParameters);
                }
    ...
    /**
     * <p>
     * This obtains the generic instantiations for the generic module arguments from the module scope.
     * </p>
     *
     * @param moduleScope
     *            The scope whose parameters we wish to instantiate.
     * @param parameters
     *            The list of actual parameter instantiations.
     *
     * @return A map containing {@link PTType}s that can are necessary to instantiate this module.
     */
    private Map<String, PTType> getGenericInstantiations(ModuleScope moduleScope, List<ModuleArgumentItem> parameters) {
        ...
        result = RCollections.foldr2(formalParams, parameters, BuildGenericInstantiations.INSTANCE, result);
    ...
    /**
     * <p>
     * This is a helper class that builds a three parameter mapping for generic instantiations.
     * </p>
     */
    private static class BuildGenericInstantiations implements
        ...
        /**
         * <p>
         * This method creates a map of program types that has been instantiated by facility declaration's module
         * arguments.
         * </p>
         *
         * @param p1
         ...
         * @param p2
         *            The module argument that instantiates {@code p1}.
         * @param p3
         *            The {@link PTType}s used to instantiate {@code p1}.
         *
