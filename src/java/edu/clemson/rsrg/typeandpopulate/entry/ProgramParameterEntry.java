...
public class ProgramParameterEntry extends SymbolTableEntry {
    ...
    /**
     * <p>
     * This defines the various different parameter modes that a {@link ParameterVarDec} can have.
     * </p>
     *
     * @version 2.0
     */
    public enum ParameterMode {
        ...
        ALTERS {
            ...
            /**
             * <p>
             * This method returns all the parameter modes that can be used to implement a particular mode.
             * </p>
             *
        ...
        /**
         * <p>
         * This method checks if a parameter mode can be implemented using {@code o}.
         * </p>
         *
         * @param o
         *            A {@link ParameterMode} to check.
         *
         * @return {@code true} if {@code o} can be used to implement this mode, {@code false} otherwise.
         */
        ...
        /**
         * <p>
         * A helper method to check whether we can implement this mode using {@code o}.
         * </p>
         *
         * @param os
         *            An array of acceptable parameter modes.
         * @param o
         *            A {@link ParameterMode} to check.
         *
         * @return {@code true} if this mode contains {@code o}, {@code false} otherwise.
         */
    ...
    public ProgramParameterEntry(TypeGraph g, String name, ResolveConceptualElement definingElement,
        ...
        myMathSymbolAlterEgo = new MathSymbolEntry(type.getTypeGraph(), name, Quantification.NONE, definingElement,
                type.toMath(), typeValue, null, null, sourceModule);

        myProgramVariableAlterEgo = new ProgramVariableEntry(getName(), getDefiningElement(),
     ...
     */
    @Override
    public final ProgramParameterEntry instantiateGenerics(Map<String, PTType> genericInstantiations,
            FacilityEntry instantiatingFacility) {
        return new ProgramParameterEntry(myTypeGraph, getName(), getDefiningElement(), getSourceModuleIdentifier(),
                myDeclaredType.instantiateGenerics(genericInstantiations, instantiatingFacility), myPassingMode);
    }
    ...
    public final ProgramTypeEntry toProgramTypeEntry(Location l) {
        ...
        if (!myPassingMode.equals(ParameterMode.TYPE)) {
            ...
            result = new ProgramTypeEntry(myTypeGraph, getName(), getDefiningElement(), getSourceModuleIdentifier(),
                    new MTNamed(myTypeGraph, getName()), new PTGeneric(myTypeGraph, getName()));
        }
