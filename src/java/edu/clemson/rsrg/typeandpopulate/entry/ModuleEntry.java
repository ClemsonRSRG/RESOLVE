...
/**
 * <p>
 * This abstract class serves as the parent class of all module entries in the symbol table.
 * </p>
 *
 * @version 2.0
 */
public abstract class ModuleEntry extends SymbolTableEntry {
    ...
    /**
     * <p>
     * An helper constructor that allow us to store the name, and the module that defined this entry for any objects
     * created from a class that inherits from {@code ModuleEntry}.
     * </p>
     *
     * @param name
     *            Name associated with this entry.
     * @param definingElement
     *            The {@link ModuleDec} that created this entry.
     */
