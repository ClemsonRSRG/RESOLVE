...
/**
 * <p>
 * A {@code NoSuchScopeException} indicates we encountered a scope that does not exist in our symbol table or in any of
 * our scopes.
 * </p>
 *
 * @version 2.0
...
public class NoSuchScopeException extends NoSuchSymbolException {
     ...
     *
     * @param e
     *            The element that we cannot locate a scope for.
     */
