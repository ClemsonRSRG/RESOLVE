...
import edu.clemson.rsrg.typeandpopulate.typereasoning.BindingExpression;
import edu.clemson.rsrg.typeandpopulate.typereasoning.TypeGraph;
import java.util.*;

/**
 * <p>
 * Indicates how one type relates to another, including a binding expression and binding conditions. This information is
 * gathered from a type theorem.
 * </p>
 *
 * @version 2.0
 */
public class TypeRelationship {
    ...
    /**
     * <p>
     * The type that we are trying to establish a relationship to.
     * </p>
     */
    ...
    /**
     * <p>
     * A list containing all the type relationship predicates.
     * </p>
     */
    ...
    /**
     * <p>
     * This constructs a type relationship between types gathered from a type theorem.
     * </p>
     *
     * @param g
     *            The current type graph.
     * @param destinationType
     *            The type we are trying to establish a relationship to.
     * @param bindingCondition
     *            The binding condition for this type.
     * @param bindingExpression
     *            The expression we are binding to.
     * @param staticPredicates
     *            The list containing all the relationship predicates.
     */
    public TypeRelationship(TypeGraph g, MTType destinationType, Exp bindingCondition, Exp bindingExpression,
    ...
    /**
     * <p>
     * Returns the binding expression as a string.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the condition expression for this type relationship.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the type we are trying to establish a relationship to.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the source type we are trying to establish a relationship.
     * </p>
     *
     * @return The {@link MTType} type object.
     */
    ...
    /**
     * <p>
     * Returns a substituted expression generated from binding condition with the mathematical type bounded to it.
     * </p>
     *
     * @param value
     *            The {@link MTType} value object we are binding.
     * @param typeBindings
     ...
     *             No solution between what we are trying to find the valid type conditions to.
     */
    public final Exp getValidTypeConditionsTo(MTType value, Map<String, MTType> typeBindings)
            throws NoSolutionException {
        ...
        MTType substitutedBinding = TypeGraph.getCopyWithVariablesSubstituted(bindingExpressionTypeValue, typeBindings);
        ...
        while (holdsSoFar && predicates.hasNext()) {
            holdsSoFar = predicates.next().canBeDemonstratedStatically(value.getType(), myDestinationType, typeBindings,
    ...
    /**
     * <p>
     * Returns a substituted expression generated from binding condition from the {@code value}.
     * </p>
     *
     * @param value
     *            The {@link Exp} value object we are retrieving the type conditions to.
     * @param typeBindings
     *            Map of established type bindings.
     *
    ...
    public final Exp getValidTypeConditionsTo(Exp value, Map<String, MTType> typeBindings) throws NoSolutionException {
        ...
        Iterator<TypeRelationshipPredicate> predicates = myStaticPredicates.iterator();
        while (holdsSoFar && predicates.hasNext()) {
            holdsSoFar = predicates.next().canBeDemonstratedStatically(value.getMathType(), myDestinationType,
        ...
        for (Map.Entry<String, Exp> substitution : internalBindings.entrySet()) {
            ...
            finalSubstitutions.put(new VarExp(newExpLoc, null, new PosSymbol(newPosSymbolLoc, substitution.getKey())),
