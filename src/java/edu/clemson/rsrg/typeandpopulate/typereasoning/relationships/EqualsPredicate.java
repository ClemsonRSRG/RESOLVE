...
/**
 * <p>
 * This class establishes that two {@link MTType}s can be established to be "equals".
 * </p>
 *
 * @version 2.0
 */
public class EqualsPredicate implements TypeRelationshipPredicate {
     ...
     * @param type1
     *            First {@link MTType} object.
     * @param type2
     *            Second {@link MTType} object.
     */
     ...
     */
    @Override
    public final boolean canBeDemonstratedStatically(MTType canonical1, MTType canonical2,
     ...
     */
    @Override
    public final TypeRelationshipPredicate replaceUnboundVariablesInTypes(Map<String, String> substitutions) {
