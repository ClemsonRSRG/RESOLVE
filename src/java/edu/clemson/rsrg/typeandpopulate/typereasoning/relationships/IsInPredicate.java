...
/**
 * <p>
 * This class establishes that one {@link MTType} can be established as "is-in" another {@link MTType}.
 * </p>
 *
 * @version 2.0
 */
public class IsInPredicate implements TypeRelationshipPredicate {
     ...
     * @param element
     *            The element {@link MTType} to be contained.
     * @param declaredType
     *            A declared {@link MTType} that can contain types.
     */
     ...
     */
    @Override
    public boolean canBeDemonstratedStatically(MTType canonical1, MTType canonical2, Map<String, MTType> typeBindings,
     ...
     */
    @Override
    public TypeRelationshipPredicate replaceUnboundVariablesInTypes(Map<String, String> substitutions) {
        VariableReplacingVisitor renamer = new VariableReplacingVisitor(substitutions, myTypeGraph);
