...
/**
 * <p>
 * A {@code DummyExp} is an {@link MathExp} guaranteed not to arise from any actual RESOLVE source code. Its only
 * property is that it has an {@link MTType}. It can be bound normally to quantified variables whose declared type it
...
public class DummyExp extends MathExp {
     ...
     * @param t
     *            A {@link MTType} representation object.
     */
    ...
    /**
     * <p>
     * This is a copy constructor that constructs a copy of the {@code DummyExp} passed in.
     * </p>
     *
     * @param original
     *            A {@code DummyExp} representation object.
     */
    ...
    /**
     * <p>
     * This method is not supported, so any caller of this method will get a {@link UnsupportedOperationException}
     * wrapped inside a {@link MiscErrorException}.
     * </p>
     */
    @Override
    public final boolean containsExp(Exp exp) {
        throw new MiscErrorException("A DummyExp cannot contain an Exp.", new UnsupportedOperationException());
    }
    ...
    public final boolean containsVar(String varName, boolean IsOldExp) {
        throw new MiscErrorException("A DummyExp cannot contain a variable.", new UnsupportedOperationException());
    }
