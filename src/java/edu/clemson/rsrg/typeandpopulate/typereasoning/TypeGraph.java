...
import edu.clemson.rsrg.typeandpopulate.typereasoning.relationships.EqualsPredicate;
import edu.clemson.rsrg.typeandpopulate.typereasoning.relationships.TypeRelationship;
import edu.clemson.rsrg.typeandpopulate.typereasoning.relationships.TypeRelationshipPredicate;
import edu.clemson.rsrg.typeandpopulate.typevisitor.CanonicalizingVisitor;
import edu.clemson.rsrg.typeandpopulate.typevisitor.UnboundTypeAccumulator;
...
/**
 * <p>
 * Represents a directed graph of types, where edges between types indicate a possible coercion that the type checker
 * can perform.
 * </p>
 *
 * @version 2.0
...
public class TypeGraph {
    ...
    /**
     * <p>
     * A set of non-thread-safe resources to be used during general type reasoning. This really doesn't belong here, but
     * anything that's reasoning about types should already have access to a type graph, and only one type graph is
     * created per thread, so this is a convenient place to put it.
     * </p>
     */
    ...
    /**
     * <p>
     * A {@link NodePairPathStrategy} for {@link Exp}.
     * </p>
     */
    ...
    /**
     * <p>
     * A {@link NodePairPathStrategy} for {@link MTType}.
     * </p>
     */
    ...
    /**
     * <p>
     * This contains all mathematical nodes for this graph.
     * </p>
     */
    ...
    /**
     * <p>
     * This contains all established relationships for mathematical subtypes.
     * </p>
     */
    private final Set<EstablishedRelationship> myEstablishedSubtypes = new HashSet<>();

    /**
     * <p>
     * This contains all established relationships for mathematical elements.
     * </p>
     */
    private final Set<EstablishedRelationship> myEstablishedElements = new HashSet<>();
    ...
    /**
     * <p>
     * Factory for creating <code>Powerclass</code> applications.
     * </p>
     */
    private final static FunctionApplicationFactory POWERCLASS_APPLICATION = new PowerclassApplicationFactory();

    /**
     * <p>
     * Factory for creating <code>Powerset</code> applications.
     * </p>
     */
    ...
    /**
     * <p>
     * Factory for creating <code>Union</code> applications.
     * </p>
     */
    ...
    /**
     * <p>
     * Factory for creating <code>Intersection</code> applications.
     * </p>
     */
    ...
    /**
     * <p>
     * Factory for creating <code>Function</code> constructor applications.
     * </p>
     */
    private final static FunctionApplicationFactory FUNCTION_CONSTRUCTOR_APPLICATION = new FunctionConstructorApplicationFactory();

    /**
     * <p>
     * Factory for creating <code>Cartesian Product</code> applications.
     * </p>
     */
    private final static FunctionApplicationFactory CARTESIAN_PRODUCT_APPLICATION = new CartesianProductApplicationFactory();
    ...
    /**
     * <p>
     * <code>Empty_Class</code>
     * </p>
     */
    public final MTProper EMPTY_CLASS = new MTProper(this, CLS, false, "Empty_Class");
     ...
     * </p>
     */
    public final MTProper EMPTY_SET = new MTProper(this, SSET, false, "Empty_Set");

    /**
     * <p>
     * <code>Receptacles</code>
     * </p>
     */
    public final MTProper RECEPTACLES = new MTProper(this, SSET, false, "Receptacles");
    ...
    /**
     * <p>
     * {@code Powerclass} function
     * </p>
     */
    public final MTFunction POWERCLASS = new MTFunction(this, true, POWERCLASS_APPLICATION, CLS, CLS);

    /**
     * <p>
     * {@code CLS} union function
     * </p>
     */
    public final MTFunction UNION = new MTFunction(this, UNION_APPLICATION, CLS, CLS, CLS);

    /**
     * <p>
     * {@code CLS} intersection function
     * </p>
     */
    public final MTFunction INTERSECT = new MTFunction(this, INTERSECT_APPLICATION, CLS, CLS, CLS);

    /**
     * <p>
     * {@code CLS} function operator
     * </p>
     */
    public final MTFunction CLS_FUNCTION = new MTFunction(this, FUNCTION_CONSTRUCTOR_APPLICATION, CLS, CLS, CLS);

    /**
     * <p>
     * {@code CLS} Cartesian product function
     * </p>
     */
    public final MTFunction CLS_CROSS = new MTFunction(this, CARTESIAN_PRODUCT_APPLICATION, CLS, CLS, CLS);
    ...
    /**
     * <p>
     * {@code Powerset} function
     * </p>
     */
    public final MTFunction POWERSET = new MTFunction(this, true, POWERSET_APPLICATION, SSET, SSET);

    /**
     * <p>
     * {@code SSet} function operator
     * </p>
     */
    public final MTFunction SSET_FUNCTION = new MTFunction(this, FUNCTION_CONSTRUCTOR_APPLICATION, SSET, SSET, SSET);

    /**
     * <p>
     * {@code SSet} Cartesian product function
     * </p>
     */
    public final MTFunction SSET_CROSS = new MTFunction(this, CARTESIAN_PRODUCT_APPLICATION, SSET, SSET, SSET);
    ...
    /**
     * <p>
     * This creates a mathematical type graph.
     * </p>
     *
    ...
    /**
     * <p>
     * Establishes that values binding to <code>bindingExpression</code> under the given environment may be considered
     ...
     * typing system a chance to provide concrete values to these "open" slots.
     * </p>
     *
     * @param bindingExpression
     *            A snippet of syntax tree describing the structure of values covered by this new relationship.
     * @param destination
     *            The mathematical type that this new relationship establishes values binding to
     *            <code>bindingExpression</code> inhabit.
     * @param bindingCondition
     *            Proof obligations that must be raised to establish that a given value binding to
     *            <code>bindingExpression</code> inhabits <code>destination</code>.
     * @param environment
     *            The environment under which <code>bindingExpression</code>, <code>destination</code>, and
     *            <code>bindingCondition</code> should be evaluated.
     */
    public final void addRelationship(Exp bindingExpression, MTType destination, Exp bindingCondition,
            Scope environment) {
        ...
        Set<String> universalVariableNames = getUniversallyQuantifiedVariables(source, destination, environment,
                sourceCanonicalResult, destinationCanonicalResult);

        Map<String, List<String>> sourceEnvironmentalToCanonical = invertMap(
                sourceCanonicalResult.canonicalToEnvironmental);
        Map<String, List<String>> destinationEnvironmentalToCanonical = invertMap(
                destinationCanonicalResult.canonicalToEnvironmental);
        ...
        Map<String, String> environmentalToExemplar = getEnvironmentalToExemplar(universalVariableNames,
                sourceEnvironmentalToCanonical, destinationEnvironmentalToCanonical);

        List<TypeRelationshipPredicate> finalPredicates = getFinalPredicates(sourceCanonicalResult,
                destinationCanonicalResult, environmentalToExemplar, universalVariableNames,
                sourceEnvironmentalToCanonical, destinationEnvironmentalToCanonical);
        ...
        TypeRelationship relationship = new TypeRelationship(this, destinationCanonicalResult.canonicalType,
    ...
    /**
     * <p>
     * Returns a new {@link MTType} with the appropriate substitutions.
     * </p>
     *
     * @param original
     *            Original mathematical type.
     * @param substitutions
    ...
    /**
     * <p>
     * Returns a new {@link Exp} with the appropriate substitutions.
     * </p>
     *
     * @param original
     *            Original expression.
     ...
     */
    public static Exp getCopyWithVariablesSubstituted(Exp original, Map<String, MTType> substitutions) {
     ...
     *
     * @param value
     *            The <code>RESOLVE</code> value to test for membership.
     * @param expected
     *            A <code>RESOLVE</code> type against which to test membership.
     *
     * @return <code>true</code> <strong>iff</strong> <code>value</code> is definitely in <code>expected</code>.
     */
    ...
    public final boolean isKnownToBeIn(MTType value, MTType expected) {
        ...
        result = myEstablishedElements.contains(r)
                || (value != CLS) && (value != ENTITY) && isSubtype(value.getType(), expected);
    ...
    /**
     * <p>
     * Returns <code>true</code> <strong>iff</strong> every value in <code>subtype</code> must necessarily be in
     * <code>supertype</code>.
     * </p>
     *
     * @param subtype
     *            A type to test if it is subsumed by <code>supertype</code>.
     * @param supertype
     *            A type to test if it subsumes <code>subtype</code>.
     *
     * @return Returns <code>true</code> <strong>iff</strong> every value in <code>subtype</code> must necessarily be in
     *         <code>supertype</code>.
     */
    public final boolean isSubtype(MTType subtype, MTType supertype) {
        ...
        try {
            result = supertype == ENTITY || supertype == CLS || myEstablishedSubtypes.contains(r)
            ...
            if (!result && subtype.getType() != null) {
                ...
                EstablishedRelationship r2 = new EstablishedRelationship(subtypetype, supertype);
                result = myEstablishedSubtypes.contains(r2) || subtypetype.equals(subtype)
        ...
        if (!result) {
            try {
                Exp conditions = getValidTypeConditions(subtype, new MTPowerclassApplication(this, supertype));
                result = MathExp.isLiteralTrue(conditions);
            } catch (TypeMismatchException e) {
                result = false;
            }
    ...
    /**
     * <p>
     * Creates canonical names for names in {@code t}.
     * </p>
     *
     * @param t
     *            A mathematical type.
     ...
     *
     * @return A {@link CanonicalizationResult} object with names in {@code t} being their canonical forms.
     */
    private CanonicalizationResult canonicalize(MTType t, Scope environment, String suffix) {
        ...
        return new CanonicalizationResult(canonicalizer.getFinalExpression(), canonicalizer.getTypePredicates(),
     ...
     * @return A modified {@link MTType}.
     */
    private MTType getCopyWithVariableNamesChanged(MTType original, Map<String, String> substitutions) {
    ...
    /**
     * <p>
     * Get a mapping from environmental variables to "exemplar" variables -- a single representative name that either
     * the source or destination will bind for us. There may be many choices, but they're all equivalent for our
     * purposes.
     * </p>
     *
     * @param universalVariableNames
     *            Set containing universal variable names.
     * @param sourceEnvironmentalToCanonical
     *            A map containing conversions to canonical forms from a source type.
     * @param destinationEnvironmentalToCanonical
     *            A map containing conversions to canonical forms from a destination type.
     *
    ...
    private static Map<String, String> getEnvironmentalToExemplar(Set<String> universalVariableNames,
        ...
        Map<String, String> environmentalToExemplar = new HashMap<>();
    ...
    /**
     * <p>
     * Returns the list of type relationships established.
     * </p>
     *
     * @param sourceCanonicalResult
     *            Canonical results from the source type.
     * @param destinationCanonicalResult
     *            Canonical results from the destination type.
     * @param environmentalToExemplar
     *            A map of environmental names to exemplar names.
     * @param universalVariableNames
     *            Set containing universal variable names.
     * @param sourceEnvironmentalToCanonical
     *            A map containing conversions to canonical forms from a source type.
    ...
    private List<TypeRelationshipPredicate> getFinalPredicates(CanonicalizationResult sourceCanonicalResult,
        ...
        List<TypeRelationshipPredicate> finalPredicates = new LinkedList<>();
        finalPredicates.addAll(replaceInPredicates(sourceCanonicalResult.predicates, environmentalToExemplar));
        finalPredicates.addAll(replaceInPredicates(destinationCanonicalResult.predicates, environmentalToExemplar));
        ...
        for (String envVar : universalVariableNames) {
            if (sourceEnvironmentalToCanonical.containsKey(envVar)
                ...
                finalPredicates.add(
                        new EqualsPredicate(this, new MTNamed(this, sourceEnvironmentalToCanonical.get(envVar).get(0)),
                                new MTNamed(this, destinationEnvironmentalToCanonical.get(envVar).get(0))));
            }
        }
    ...
    /**
     * <p>
     * Returns the conditions required to establish that <code>foundValue</code> is a member of the type represented by
     * <code>expectedEntry</code> along the path from <code>foundEntry</code> to <code>expectedEntry</code>. If no such
     * conditions exist (i.e., if the conditions would be <code>false</code>), throws a
     * <code>TypeMismatchException</code>.
     * </p>
     *
     * @param foundValue
     *            The value we'd like to establish is in the type represented by <code>expectedEntry</code>.
     * @param foundEntry
     *            A node in the type graph of which <code>foundValue</code> is a syntactic subtype.
     * @param expectedEntry
     *            A node in the type graph of which representing a type in which we would like to establish
     *            <code>foundValue</code> resides.
     * @param pathStrategy
     *            The strategy for following the path between <code>foundEntry</code> and <code>expectedEntry</code>.
     *
     * @return The conditions under which the path can be followed.
     *
     * @throws TypeMismatchException
     *             If the conditions under which the path can be followed would be <code>false</code>.
     */
    private <V> Exp getPathConditions(V foundValue, Map.Entry<MTType, Map<String, MTType>> foundEntry,
        ...
        return pathStrategy.getValidTypeConditionsBetween(foundValue, foundEntry.getKey(), expectedEntry.getKey(),
                combinedBindings);
    }

    /**
     * <p>
     * This method returns all the syntactic subtypes associated with {@code query} as well as any type relationships
    ...
    /**
     * <p>
     * This method returns the type node representing {@code t}.
     * </p>
     *
     * @param t
     *            A mathematical type.
     ...
     *            A <code>RESOLVE</code> type against which to test membership.
     *
     * @return The conditions under which <code>value</code> could be demonstrated to be in <code>expected</code>.
     *
     * @throws TypeMismatchException
     *             If there are no known conditions under which <code>value</code> could be demonstrated to be in
     *             <code>expected</code>.
     */
    private Exp getValidTypeConditions(MTType value, MTType expected) throws TypeMismatchException {
        ...
        if (expected == CLS) {
            ...
            if (value.equals(EMPTY_CLASS)) {
                ...
                MTPowerclassApplication expectedAsPowerclassApplication = (MTPowerclassApplication) expected;

                DummyExp memberOfValue = new DummyExp(null, value);

                if (isKnownToBeIn(memberOfValue, expectedAsPowerclassApplication.getArgument(0))) {
                    result = MathExp.getTrueVarExp(null, this);
                }
            }
        }
        ...
        if (!MathExp.isLiteralTrue(result)) {
            ...
            if (value == CLS || value == ENTITY) {
                throw new TypeMismatchException("Unexpected mathematical type: " + value);
            }

            try {
                Exp intermediateResult = getValidTypeConditions(value, value.getType(), expected, MTTYPE_VALUE_PATH);

                if (MathExp.isLiteralTrue(intermediateResult)) {
                    result = intermediateResult;
                } else {
                    result = MathExp.formDisjunct(result.getLocation(), result, intermediateResult);
                }
     ...
     *             <code>expected</code>.
     */
    private Exp getValidTypeConditions(Exp value, MTType expected) throws TypeMismatchException {
        Exp result;

        MTType valueTypeValue = value.getMathTypeValue();
        if (expected == ENTITY && valueTypeValue != CLS && valueTypeValue != ENTITY) {
    ...
    /**
     * <p>
     * Returns the conditions under which <code>foundValue</code>, which is of type <code>foundType</code>, could be
     * demonstrated to be a member of <code>expected</code>. Individual paths are tested using the given
     ...
     *            The <code>RESOLVE</code> value to test for membership.
     * @param foundType
     *            The mathematical type of the <code>RESOLVE</code> value to test for membership.
     * @param expected
     *            A <code>RESOLVE</code> type against which to test membership.
     *
     * @return The conditions under which <code>value</code> could be demonstrated to be in <code>expected</code>.
    ...
    private <V> Exp getValidTypeConditions(V foundValue, MTType foundType, MTType expected,
        ...
        Map<MTType, Map<String, MTType>> potentialFoundNodes = getSyntacticSubtypesWithRelationships(foundType);
        Map<MTType, Map<String, MTType>> potentialExpectedNodes = getSyntacticSubtypesWithRelationships(expected);
        ...
        Iterator<Map.Entry<MTType, Map<String, MTType>>> foundEntries = potentialFoundNodes.entrySet().iterator();
        ...
        while (!foundTrivialPath && foundEntries.hasNext()) {
            ...
            while (!foundTrivialPath && expectedEntries.hasNext()) {
                ...
                try {
                    ...
                    foundPath = foundPath | !MathExp.isLiteralFalse(newCondition);

                    foundTrivialPath = MathExp.isLiteralTrue(newCondition);

                    result = MathExp.formDisjunct(newCondition.getLocation(), newCondition, result);
                } catch (TypeMismatchException e) {
                }
            }
        }
    ...
    /**
     * <p>
     * This method returns the set of universally quantified variables in the current scope.
     * </p>
     *
     * @param source
     *            Source mathematical type.
     * @param destination
     *            Destination mathematical type.
     * @param environment
     *            The searching scope.
     * @param sourceCanonicalResult
     *            Canonical results from the source type.
    ...
    private static Set<String> getUniversallyQuantifiedVariables(MTType source, MTType destination, Scope environment,
        ...
        try {
            while (!nextBatch.isEmpty()) {
                ...
                for (String newUnboundType : newUnboundTypes) {
                    ...
                    // already have bombed
                    MathSymbolEntry entry = (MathSymbolEntry) environment
        ...
        if (!remaining.isEmpty()) {
            throw new IllegalArgumentException(
                    "The following universal " + "type variables will not be bound: " + remaining);
        }
    ...
    /**
     * <p>
     * An helper method that inverts entries in a map.
     * </p>
     *
     * @param original
     *            The original map.
     * @param <K>
     *            The class associated with the map's keys.
     * @param <V>
     *            The class associated with the map's values.
     *
    ...
    /**
     * <p>
     * An helper method that replaces {@link TypeRelationshipPredicate TypeRelationshipPredicates}.
     * </p>
     *
     * @param original
     *            The original list.
     ...
     */
    private static List<TypeRelationshipPredicate> replaceInPredicates(List<TypeRelationshipPredicate> original,
    ...
    /**
     * <p>
     * An helper method that invokes the {@link Exp#substitute(Map)} method and takes care of any potential exceptions.
     * </p>
     *
     * @param original
     *            Original expression.
     * @param replacements
     *            A map of replacement expressions.
     * @param environmentalToExemplar
     *            A map of environmental names to exemplar names.
     *
    ...
    /**
     * <p>
     * An helper method that updates entries in a map.
     * </p>
     *
     * @param original
     *            The original map.
     * @param suffix
     *            The new suffix to be added to the map's key.
     * @param <T>
     *            The class associated with the map's values.
     *
    ...
    /**
     * <p>
     * An helper class that helps establish canonicalization results for a {@link MTType}.
     * </p>
     */
    private class CanonicalizationResult {
        ...
        /**
         * <p>
         * A list of established type relationships.
         * </p>
         */
        ...
        /**
         * <p>
         * This creates a canonicalization result for {@code canonicalType}.
         * </p>
         *
         * @param canonicalType
         *            A mathematical type.
         * @param predicates
         *            A list of established type relationships.
         * @param canonicalToOriginal
         *            A map of conversions.
         */
        CanonicalizationResult(MTType canonicalType, List<TypeRelationshipPredicate> predicates,
    ...
    /**
     * <p>
     * A strategy pattern interface for a class type {@code V} that tests valid type conditions between a source and
     * expected {@link MTType MTTypes}.
     * </p>
     *
     * @param <V>
     *            The class of objects to be tested.
     */
    private interface NodePairPathStrategy<V> {

        /**
         * <p>
         * This method establishes a valid type conditions for {@code sourceValue} using {@code sourceType},
         * {@code expectedType} and {@code bindings}.
         * </p>
         *
         * @param sourceValue
         *            An object of type {@link V}.
         * @param sourceType
         *            The mathematical source type.
         * @param expectedType
         *            The mathematical expected type.
         * @param bindings
         *            Map of established type bindings.
         *
         * @return An {@link Exp} with the valid type conditions between the types.
         *
         * @throws TypeMismatchException
         *             We cannot establish a type condition between the types for {@code sourceValue}.
         */
        Exp getValidTypeConditionsBetween(V sourceValue, MTType sourceType, MTType expectedType,
    ...
    /**
     * <p>
     * An implementation of {@link NodePairPathStrategy} for {@link Exp}.
     * </p>
     */
    private class ExpValuePathStrategy implements NodePairPathStrategy<Exp> {
         ...
         */
        @Override
        public final Exp getValidTypeConditionsBetween(Exp sourceValue, MTType sourceType, MTType expectedType,
                Map<String, MTType> bindings) throws TypeMismatchException {
    ...
    /**
     * <p>
     * An implementation of {@link NodePairPathStrategy} for {@link MTType}.
     * </p>
     */
    private class MTTypeValuePathStrategy implements NodePairPathStrategy<MTType> {
         ...
         */
        @Override
        public final Exp getValidTypeConditionsBetween(MTType sourceValue, MTType sourceType, MTType expectedType,
                Map<String, MTType> bindings) throws TypeMismatchException {
            return myTypeNodes.get(sourceType).getValidTypeConditionsTo(sourceValue, expectedType, bindings);
        }
    ...
    /**
     * <p>
     * This creates a {@link MTPowerclassApplication} type.
     * </p>
     */
    private static class PowerclassApplicationFactory implements FunctionApplicationFactory {
         ...
         */
        @Override
        public final MTType buildFunctionApplication(TypeGraph g, MTFunction f, String calledAsName,
    ...
    /**
     * <p>
     * This creates a {@link MTPowersetApplication} type.
     * </p>
     */
    private static class PowersetApplicationFactory implements FunctionApplicationFactory {
    ...
    /**
     * <p>
     * This creates a {@link MTUnion} type.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates a {@link MTIntersect} type.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates a {@link MTFunction} type.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates a {@link MTCartesian} type.
     * </p>
     */
    ...
    /**
     * <p>
     * An helper class that indicates an established type relationship between two {@link MTType MTTypes}.
     * </p>
     */
    private static class EstablishedRelationship {
        ...
        /**
         * <p>
         * The mathematical types that has been established a type relationship.
         * </p>
         */
        ...
        /**
         * <p>
         * This constructs an object that indicates that we have established a type relationship between {@code t1} and
         * {@code t2}.
         * </p>
         *
         * @param t1
        ...
        /**
         * <p>
         * This method overrides the default {@code hashCode} method implementation for the
         * {@code EstablishedRelationship} class.
         * </p>
         *
        ...
        /**
         * <p>
         * This method overrides the default {@code equals} method implementation to ensure that we have a correctly
         * established type relationship.
         * </p>
         *
         * @param o
