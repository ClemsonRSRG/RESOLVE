...
/**
 * <p>
 * This is a sanity checker for making sure all operations from the specification are implemented by the realization.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class ImplementAllOperChecker {
    ...
    /**
     * <p>
     * Creates a sanity checker for checking whether or not the realization implements all the operations in a given
     * {@code Concept}/{@code Enhancement}.
     * </p>
     *
     * @param location
     *            The module that called this method.
     * @param specDecs
     *            List of decs of the Concept/Enhancement
     * @param realizationDecs
     *            List of decs of the realization.
     */
    public ImplementAllOperChecker(Location location, List<Dec> specDecs, List<Dec> realizationDecs) {
        myLocation = location;
        mySpecDecs = specDecs;
    ...
    /**
     * <p>
     * Checks to see if all operation specified by {@code Concept}/{@code Enhancement} are implemented by the
     * corresponding realization.
     * </p>
     *
     * @throws SourceErrorException
     *             This is thrown when an operation isn't implemented.
     */
    public final void implementAllOper() throws SourceErrorException {
        ...
        for (Dec d1 : opDecList1) {
            ...
            if (!inRealization) {
                throw new SourceErrorException("Operation " + d1.getName() + " not implemented by the realization.",
                        myLocation);
            }
        }
    }
    ...
    /**
     * <p>
     * Obtains the list of all <code>OperationDec</code> and <code>ProcedureDec</code>.
     * </p>
     *
     * @param decs
