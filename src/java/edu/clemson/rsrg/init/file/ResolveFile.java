...
/**
 * <p>
 * This class is the standard "file" format for the RESOLVE compiler. Since the compiler can be invoked from the web
 * interface, we need to be able to support both "real" and "meta" files. Rather than having two compilation paths that
 * look almost identical, we convert all inputs and create an instance of this class.
 * </p>
 *
 * @author Yu-Shan Sun
 *
...
public class ResolveFile {
    ...
    /**
     * <p>
     * This constructor takes all the information relevant from the original source object and creates a "file" object
     * that the compiler will operate on.
     * </p>
     *
     * @param fileBasicInfo
     ...
     * @param packageList
     *            The package where this source file belong.
     * @param filePath
     *            The path where this file was found.
     */
    public ResolveFile(ResolveFileBasicInfo fileBasicInfo, ModuleType moduleType, CharStream input, Path parentPath,
    ...
    public final boolean equals(Object o) {
        ...
        if (!myModuleFileType.equals(that.myModuleFileType))
            return false;
        if (myParentPath != null ? !myParentPath.equals(that.myParentPath) : that.myParentPath != null)
            return false;
    ...
    /**
     * <p>
     * This returns a path where this {@link ResolveFile} would be located in our workspace.
     * </p>
     *
    ...
    /**
     * <p>
     * If the option to translate to Java or create an executable jar is given, this is the RESOLVE folder structure for
     * the given file.
     * </p>
     *
    ...
    public final int hashCode() {
        ...
        result = 31 * result + (myParentPath != null ? myParentPath.hashCode() : 0);
    ...
    public final String toString() {
        return myFileBasicInfo.toString() + "." + myModuleFileType.getExtension();
    }
