...
/**
 * <p>
 * A <code>FlagManager</code> represents an actual configuration of flags, as provided by the user. It may be queried to
 * find out what flags are set, or what the values of parameters are.
 * </p>
 *
...
public class FlagManager {
    ...
    private Map<Flag, FlagInfo> myFlags = new HashMap<>();
    private final String[] myRemainingArgs;
    private static FlagManager global_instance;

    /**
     * <p>
     * Creates a new <code>FlagManager</code> based on the provided user command-line arguments and the current state of
     * {@link FlagDependencies FlagDependencies}.
     * </p>
     *
     * @param args
    ...
    public FlagManager(String[] args) throws FlagDependencyException {
        ...
        if (!FlagDependencies.isSealed()) {
            throw new IllegalStateException(
                    "FlagDependencies must be sealed " + "with a call to seal() before arguments can be processed.");
        }
    ...
    /**
     * <p>
     * All arguments in the originally provided array of arguments that looked like flags but didn't match a known flag,
     * up to the first argument that didn't look like a flag, concatenated with all arguments starting at the first
     * argument that didn't look like a flag to the end.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns <code>true</code> <strong>iff</strong> the provided flag is set. Flags can be set either directly by the
     * user, implicitly because they have default parameter values, or implicitly by another flag that was set and had
     * an <em>implies</em> relationship with the provided flag.
     * </p>
     *
     * @param f
     *            The flag to check whether or not it is set.
     *
    ...
    /**
     * <p>
     * Returns the argument provided for a particular parameter name of the given flag.
     * </p>
     *
     * @param f
     *            The flag whose argument we would like.
     * @param parameterName
     *            The parameter whose value we would like, as original provided to the <code>Flag</code> constructor.
     *
     * @return The value of the named parameter, either as provided explicitly by the user or implicitly via the
     *         default.
     *
     * @throws NullPointerException
     *             If the given flag is not set.
     */
    ...
    private String[] processArguments(String[] args) throws FlagDependencyException {
        ...
        List<String> unrecognized = new LinkedList<>();
    ...
    private void setImpliedFlags() {
        ...
        Map<Flag, FlagInfo> needToBeSet = new HashMap<>();
    ...
    void turnOnFlag(Flag f, Flag reason, Map<String, String> argumentMapping) {
        myFlags.put(f, new FlagInfo(reason, new HashMap<>(argumentMapping)));
    }
