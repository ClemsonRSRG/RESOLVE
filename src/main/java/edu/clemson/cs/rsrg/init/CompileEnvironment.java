...
/**
 * <p>
 * This class stores all necessary objects and flags needed during the
...
public class CompileEnvironment {
    ...
    /**
     * <p>
     * This contains all modules we have currently seen. This includes both
     * complete and incomplete
     * modules. A module is complete when we are done processing it. An
     * incomplete module usually
     * means that we are still processing it's import.
     * </p>
     */
    ...
    /**
     * <p>
     * This map stores all externally realizations for a particular concept. The
     * {@code Archiver}
     * should be the only one that cares about these files.
     * </p>
     */
    ...
    /**
     * <p>
     * This list stores listener objects that provides instant feedback to the
     * interested party when
     * we are done with a compilation activity.
     * </p>
     */
    ...
    /**
     * <p>
     * This object contains all the flag objects that have been created by the
     * different modules.
     * </p>
     */
    ...
    /**
     * <p>
     * Instantiates a compilation environment to store all necessary modules,
     * files and flags.
     * </p>
     *
     ...
     *         flags.
     * @throws IOException There was an error creating the specified error log
     *         file.
     */
    public CompileEnvironment(String[] args, String compilerVersion,
        ...
        if (flags.isFlagSet(ResolveCompiler.FLAG_WORKSPACE_DIR)) {
            path = flags.getFlagArgument(ResolveCompiler.FLAG_WORKSPACE_DIR,
                    "Path");
        }
        ...
        if (flags.isFlagSet(ResolveCompiler.FLAG_DEBUG_FILE_OUT)) {
            ...
            statusHandler = new WriterStatusHandler(
                    Files.newBufferedWriter(infoFilePath, charset, CREATE,
                            APPEND),
                    Files.newBufferedWriter(errorFilePath, charset, CREATE,
                            APPEND));
        }
     ...
     * </p>
     *
     * @param id The ID for the {@link ResolveFile} that we want to set as
     *        externally realized.
    ...
    /**
     * <p>
     * Remove the module associated with the {@link ModuleIdentifier} from our
     * incomplete module
     * stack. This indicates the completion of this module.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns all the output listeners that are interested in the compilation
     * results.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns {@link ResolveFile} for the specified string object. Notice that
     * the pre-condition for
     * this method is that the key exist in the map.
     * </p>
     *
     ...
     */
    public final ResolveFile
            getUserFileFromMap(ResolveFileBasicInfo fileBasicInfo) {
    ...
    /**
     * <p>
     * This checks to see if the module associated with this id is an externally
     * realized file.
     * </p>
     *
     * @param id The ID for the {@link ResolveFile} we want to search for.
     *
     * @return {@code true} if it is externally realized, {@code false}
     *         otherwise.
     */
    ...
    /**
     * <p>
     * This checks to see if the module associated with this id has been
     * compiled or not.
     * </p>
     *
     * @param id The ID for the {@link ResolveFile} we want to search for.
    ...
    /**
     * <p>
     * This checks to see if the file is a user created file from the
     * WebIDE/WebAPI.
     * </p>
     *
     * @param fileBasicInfo The name of the file including any known parent
    ...
    /**
     * <p>
     * Used to set a map of user files when invoking the compiler from the
     * WebIDE/WebAPI.
     * </p>
     *
    ...
    public final void setSymbolTable(ScopeRepository table) {
        if (table == null) {
            throw new MiscErrorException("Symbol table may not be set to null!",
