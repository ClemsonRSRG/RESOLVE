...
public class FileOutputListener implements OutputListener {
    ...
    public final void astGraphvizModelResult(ModuleDec dec, String graphvizModel) {
        String outputFileName = dec.getName().getName() + "_ModuleDec.gv";
        writeToFile(outputFileName, graphvizModel);
    }
     ...
     */
    @Override
    public final void javaTranslationResult(ModuleDec dec,
     ...
     * @param rawOutput The output string generated by the {@link VCGenerator}.
     */
    @Override
    public final void vcGeneratorResult(ModuleDec dec,
            List<AssertiveCodeBlock> blocks, String rawOutput) {
        String outputFileName = dec.getName().getName() + ".asrt";
        writeToFile(outputFileName, rawOutput);
    }
