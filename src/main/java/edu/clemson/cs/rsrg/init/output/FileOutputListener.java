...
public class FileOutputListener implements OutputListener {
     ...
     *
     * @param file The {@link ResolveFile} we are generating VCs for.
     ...
     */
    @Override
    public final void vcGeneratorResult(ResolveFile file,
        ...
        ST model =
                group.getInstanceOf("outputVCGenFile")
                        .add("fileName", file.toString()).add("dateGenerated",
                        new Date());
        ...
        // Append VCs details with any verbose output
        sb.append(verboseOutput);

        // Output the results to file
        String outputFileName = file.getName() + ".asrt";
