...
import edu.clemson.cs.rsrg.prover.immutableadts.SingletonImmutableList;
...
public class PLambda extends PExp {
    ...
    public final PLambda withNormalizedParameterNames() {
        ...
        return new PLambda(new ArrayBackedImmutableList<>(normParams),
    ...
    protected final List<PExp> getFunctionApplicationsNoCache() {
        List<PExp> bodyFunctions =
                new LinkedList<>(myBody.getFunctionApplications());
