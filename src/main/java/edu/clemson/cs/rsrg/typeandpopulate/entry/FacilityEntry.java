...
public class FacilityEntry extends SymbolTableEntry {
    ...
    /** <p>The list of enhancements in this facility entry.</p> */
    private final List<ModuleParameterization> myEnhancements = new LinkedList<>();

    /** <p>The scope where this instantiation is happening in.</p> */
    private final ScopeRepository mySourceRepository;

    /** <p>The map that indicates where each spec is being realized.</p> */
    private final Map<ModuleParameterization, ModuleParameterization>
            myEnhancementRealizations = new HashMap<>();
    ...
    public FacilityEntry(FacilityDec facility, boolean isSharingConceptInstantiation,
        ...
        if (facility.getConceptRealizName() != null) {
            realization = new ModuleParameterization(
                    new ModuleIdentifier(facility.getConceptRealizName().getName()),
        ...
        for (EnhancementSpecRealizItem enhancement : facility.getEnhancementRealizPairs()) {
            spec = new ModuleParameterization(
                    new ModuleIdentifier(enhancement.getEnhancementName().getName()),
    ...
    /**
     * <p>This method returns all the enhancements declared in this
     * facility entry.</p>
     *
    ...
    /**
     * <p>This returns the module specification and realization pairing
     * for this facility entry.</p>
     *
