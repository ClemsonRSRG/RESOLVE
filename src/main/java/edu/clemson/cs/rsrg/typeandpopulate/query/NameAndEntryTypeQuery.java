...
public class NameAndEntryTypeQuery<E extends SymbolTableEntry>
    ...
    /**
     * <p>
     * This query searches for all entries that match the given name and has
     * type <code>T</code>.
     * </p>
     *
     ...
     * as a
     * {@link PosSymbol} and has type <code>T</code>.
     * </p>
     *
     * @param qualifier A qualifier symbol that indicates the instantiating
     *        facility or module.
     ...
     * This query searches for all entries that match the given name and has
     * type <code>T</code>,
     * using no import or facility strategies and no local priority.
     * </p>
     *
     * @param qualifier A qualifier symbol that indicates the instantiating
     *        facility or module.
     ...
     * This query searches for all entries that match the given name represented
     * as a
     * {@link PosSymbol} and has type <code>T</code>, using no import or
     * facility strategies and no
     * local priority.
     * </p>
     *
     * @param qualifier A qualifier symbol that indicates the instantiating
