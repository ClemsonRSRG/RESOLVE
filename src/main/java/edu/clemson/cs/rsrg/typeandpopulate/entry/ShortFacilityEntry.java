...
public class ShortFacilityEntry extends ModuleEntry {
     ...
     * @param enclosedFacility The facility entry located inside this entry.
     */
    public ShortFacilityEntry(String name,
            ShortFacilityModuleDec definingElement,
     ...
     */
    @Override
    public final ShortFacilityEntry instantiateGenerics(
            Map<String, PTType> genericInstantiations,
            FacilityEntry instantiatingFacility) {
        return new ShortFacilityEntry(getName(),
                (ShortFacilityModuleDec) getDefiningElement(),
