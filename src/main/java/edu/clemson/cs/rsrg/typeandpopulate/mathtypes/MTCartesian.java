...
/**
 * <p>A constructed type that is a Cartesian product over one or more
 * elements.</p>
 *
 * @version 2.0
 */
public class MTCartesian extends MTAbstract<MTCartesian> {
    ...
    /** <p>List of {@link Element}s that are in this type.</p> */
    private List<Element> myElements = new LinkedList<>();

    /** <p>List of {@link MTType}s corresponding to each element.</p> */
    private List<MTType> myElementTypes = new LinkedList<>();

    /** <p>A mapping of {@link Element}s in this type.</p> */
    private Map<String, Element> myTagsToElementsTable =
            new HashMap<>();

    /** <p>A reverse mapping of {@link Element}s in this type.</p> */
    private Map<Element, String> myElementsToTagsTable =
            new HashMap<>();

    /** <p>The number of elements in this type.</p> */
    ...
    /**
     * <p>This constructs a Cartesian type with {@link Element}s
     * that will be in this type.</p>
     *
    ...
    /**
     * <p>This constructs a Cartesian type with a list of
     * {@link Element}s that will be in this type.</p>
     *
     * @param g The current type graph.
     * @param elements A list of {@link Element}s that are in this Cartesian type.
     */
    ...
    /**
     * <p>This constructs a Cartesian type with an array of
     * {@link Element}s of this type with an element counter.</p>
     *
     * @param g The current type graph
     * @param elements An array of {@link Element}s that are in this Cartesian type.
    ...
    /**
     * <p>This method returns the {@link MTType} associated
     * with the index.</p>
     *
     * @param index An index.
     *
     * @return The type corresponding to the {@link Element} specified
     * by the index.
     */
    ...
    /**
     * <p>This method returns a formatted string for the elements
     * in this type.</p>
     *
    ...
    /**
     * <p>This method returns the symbol representation of the
     * {@link Element} at the specified index.</p>
     *
     * @param index An index.
     *
    ...
    /**
     * <p>This method returns the size of the Cartesian product
     * type.</p>
     *
     * @return An integer.
     */
    ...
    /**
     * <p>This retrieves the {@link Element} located at the specified
     * index.</p>
     *
     * @param index An index.
     *
    ...
    /**
     * <p>This helper class allow us to store a name for an element in
     * the Cartesian type and the type for the element.</p>
     *
     * @version 2.0
     */
    public static class Element {
        ...
        /**
         * <p>This constructs a new element from an existing {@link Element}.</p>
         *
        ...
        /**
         * <p>This constructs a new element using the element's type.</p>
         *
        ...
        /**
         * <p>This constructs a new element from the tag and the type.</p>
         *
        ...
        /**
         * <p>An helper method to update the maps.</p>
         *
         * @param elements Original list of {@link Element}s.
         * @param elementTypes Original list of {@link MTType}s.
         * @param tagsToElements A map contains a mapping of strings to {@link Element}s
         *                       that needs to be updated.
         * @param elementsToTags A map contains a mapping of strings to {@link MTType}s
         *                       that needs to be updated.
         */
        private void addTo(List<Element> elements, List<MTType> elementTypes, Map<String, Element> tagsToElements, Map<Element, String> elementsToTags) {
            elements.add(this);
