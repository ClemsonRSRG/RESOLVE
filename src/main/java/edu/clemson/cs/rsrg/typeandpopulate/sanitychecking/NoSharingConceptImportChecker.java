...
/**
 * <p>
 * This is a sanity checker for making sure our uses list does not contain a
 * {@code sharing concept}
 * directly or is importing an instantiated {@code facility} of a
 * {@code sharing concept}.
 * </p>
 *
 * @author Yu-Shan Sun
...
public class NoSharingConceptImportChecker {
    ...
    /**
     * <p>
     * Creates a sanity checker for checking whether or not the we import a
     * {@code sharing concept}.
     * </p>
     *
     ...
     */
    public NoSharingConceptImportChecker(Location location, ModuleDec moduleDec,
    ...
    /**
     * <p>
     * This method indicates whether or not we are importing a
     * {@code sharing concept}.
     * </p>
     *
    ...
    public final boolean importingSharingConcept() {
        ...
        if (myModuleDec instanceof ConceptModuleDec) {
            ...
            FacilityEntry facilityEntry = getFacilityEntry(
                    ((ShortFacilityModuleDec) myModuleDec).getDec().getName());
     ...
     *
     * @return A {@link FacilityEntry} if found. Otherwise a
     *         {@link SourceErrorException} will be
     *         thrown.
     */
    private FacilityEntry getFacilityEntry(PosSymbol name) {
        ...
        try {
            entry = myCurrentScope
                    .queryForOne(new NameQuery(null, name,
            ...
            throw new SourceErrorException(
                    "Duplicate symbol: " + name + ". Consider qualifying.",
                    myLocation);
        }
