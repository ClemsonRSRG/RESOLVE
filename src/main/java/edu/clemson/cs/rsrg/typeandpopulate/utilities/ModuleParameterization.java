...
/**
 * <p>A <code>ModuleParameterization</code> is part of a facility declaration
 * where it is using a spec ({@link ConceptModuleDec}/{@link EnhancementModuleDec})
 * or a realization ({@link ConceptRealizModuleDec}/{@link EnhancementRealizModuleDec}).</p>
 *
 * @version 2.0
 */
public class ModuleParameterization {
    ...
    /** <p>The scope that this instantiation is happening in.</p> */
    private final ScopeRepository mySourceRepository;

    /** <p>The module that is being instantiated.</p> */
    private final ModuleIdentifier myModule;

    /** <p>The list of parameters needed to instantiate this module.</p> */
    private final List<ModuleArgumentItem> myParameters = new LinkedList<>();

    /** <p>The facility that is instantiating the module.</p> */
    ...
    /**
     * <p>This constructs a module parameter object with no arguments.</p>
     *
    ...
    /**
     * <p>This constructs a module parameter object.</p>
     *
     * @param module The module that is being instantiated.
    ...
    /**
     * <p>This method returns the module identifier for the module
     * that this object refers to.</p>
     *
    ...
    /**
     * <p>This method returns the module arguments used to instantiate
     * this object.</p>
     *
    ...
    /**
     * <p>This method returns the scope for this module parameter object.</p>
     *
     * @param instantiated Boolean flag to indicate whether or not
     *                     this object has been instantiated.
     *
     * @return An {@link InstantiatedScope} with either the generic
     * parameters or instantiated version of the parameters.
     */
    ...
    /**
     * <p>This obtains the generic instantiations for the generic
     * module arguments from the module scope.</p>
     *
     ...
     *
     * @return A map containing {@link PTType}s that can are necessary
     * to instantiate this module.
     */
    private Map<String, PTType> getGenericInstantiations(ModuleScope moduleScope, List<ModuleArgumentItem> parameters) {
    ...
    /**
     * <p>This is a helper class that builds a three parameter mapping for
     * generic instantiations.</p>
     */
    private static class BuildGenericInstantiations implements Utilities.Mapping3<ProgramParameterEntry, ModuleArgumentItem, Map<String, PTType>, Map<String, PTType>> {

        // ===========================================================
        // Member Fields
        // ===========================================================

        /** <p>A singleton instance that builds the mapping.</p> */
        ...
        /**
         * <p>This method creates a map of program types that has been instantiated
         * by facility declaration's module arguments.</p>
         *
         ...
         */
        @Override
        public final Map<String, PTType> map(ProgramParameterEntry p1, ModuleArgumentItem p2, Map<String, PTType> p3) {
            if (p1.getParameterMode().equals(ProgramParameterEntry.ParameterMode.TYPE)) {
