...
/**
 * <p>
 * This class attempts to bind an expression using the type graph and any type
 * bindings we currently
 * have.
 * </p>
 *
 * @version 2.0
...
public class BindingExpression {
    ...
    /**
     * <p>
     * This constructs an object where we are going to attempt bind the
     * {@code expression} passed in
     * using our current {@link TypeGraph}.
     * </p>
     *
     * @param g The current type graph.
     * @param expression The expression we are attempting to bind.
     */
    ...
    /**
     * <p>
     * This method attempts to bind the expression in this object with the
     * expression passed in and
     * the map of type bindings.
     * </p>
     *
     * @param expr The expression we want bind our expression to.
     * @param typeBindings A map of type bindings.
     *
    ...
    /**
     * <p>
     * This method gets the mathematical type associated with the expression in
     * this object.
     * </p>
     *
    ...
    /**
     * <p>
     * This method gets the mathematical type value associated with the
    ...
    private void bindTo(Exp expr1, Exp expr2, Map<String, MTType> typeBindings,
        ...
        if (!myTypeGraph.isSubtype(expr2Type, expr1Type)) {
            throw new TypeMismatchException("Type: " + expr2Type
                    + " is not a subtype of type: " + expr1);
        }
    ...
    /**
     * <p>
     * This method gets the mathematical type for the passed in type after we
     * apply all the type
     * bindings.
     * </p>
     *
     * @param original The original mathematical type.
     * @param typeBindings A map of type bindings.
     *
     * @return The {@link MTType} type object.
     */
