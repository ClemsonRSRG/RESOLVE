...
/**
 * <p>This class attempts to bind an expression using the type graph
 * and any type bindings we currently have.</p>
 *
 * @version 2.0
 */
public class BindingExpression {
    ...
    /** <p>The expression we are attempting to bind</p> */
    ...
    /**
     * <p>This constructs an object where we are going to attempt
     * bind the {@code expression} passed in using our current
     * {@link TypeGraph}.</p>
     *
    ...
    /**
     * <p>This method attempts to bind the expression in this object
     * with the expression passed in and the map of type bindings.</p>
     *
     ...
     * with the expression in this object.</p>
     *
    ...
    /**
     * <p>This method gets the mathematical type for the passed in type
     * after we apply all the type bindings.</p>
     *
