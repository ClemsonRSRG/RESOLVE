 ...
 * the top-level dummy
 * scope), represented by a {@link ResolveConceptualElement} called its
 * <em>defining element</em>.
 * Such a scope therefore exists in a <em>lexical hierarchy</em> of those scopes
 * introduced by its
 * defining element's parent elements, necessarily passing through a
 * {@link ModuleScope} (belonging
 * to this scope's <em>source module</em>) before reaching the top-level dummy
 * scope. If this scope
 ...
 * be retrieved from a
 * {@link ScopeRepository} or constructed via some of the methods of
...
public abstract class SyntacticScope extends AbstractScope {
    ...
    /**
     * <p>
     * This creates a new scope for a {@link ResolveConceptualElement}.
     * </p>
     *
    ...
    /**
     * <p>
     * Begins applying the given {@link TableSearcher} up the lexical hierarchy
     * that ends in this
     * scope, starting with this scope, thus adding any matches to
     * <code>matches</code>. For the
     * purposes of the search and the returned results, any generics will be
     * instantiated
     ...
     *
     * <p>
     * The search will continue upward toward the top-level global scope until
     ...
     * <li><code>searcher</code>'s
     * {@link TableSearcher#addMatches(SymbolTable, List, TableSearcher.SearchContext)}
     * method returns
     ...
     *
     * <p>
     * In the first three cases, the method returns normally, with any matches
     * added to
     * <code>matches</code>. If no matches are found, <code>matches</code> will
     * simply be left
     * unchanged.
     * </p>
     *
     * <p>
     * In the last case, this method will throw a
     * <code>DuplicateSymbolException</code>.
     * </p>
     *
     * <p>
     * Regardless of how this method terminates, any searched scopes will be
     * added to
     * <code>searchedScopes</code>.
     * </p>
     *
     ...
     *        types, which will be
     *        applied when searching and returning results.
     * @param instantiatingFacility A pointer to the symbol table entry
     *        corresponding to the facility
     *        that provided the instantiation of the generics given by
     *        <code>genericInstantiations</code>, or <code>null</code> if we are
     *        not searching an
     *        instantiated scope. If this parameter is <code>null</code> then
     ...
     *         list of search
     *         results; i.e., no further scopes should be considered.
     *         <code>false</code> indicates
     *         that the search should continue, provided there are additional
     *         un-searched scopes.
     */
    @Override
    ...
    /**
     * <p>
     * Returns a list of {@link ProgramParameterEntry}s contained directly in
     * this scope. These
     * correspond to the formal parameters defined by the syntactic element that
     * introduced the scope.
     * </p>
     *
     * <p>
     * If there are no parameters, or the syntactic element is not of the sort
     * that can define
    ...
    public final List<ProgramParameterEntry> getFormalParameterEntries() {
        List<ProgramParameterEntry> result = new LinkedList<>();
    ...
    /**
     * <p>
     * Returns the module identifier for the module that instantiated this
     * scope.
     * </p>
     *
    ...
    /**
     * <p>
     * Searches for symbols by the given query, using this <code>Scope</code> as
     * the source scope of
     * the search, i.e. the scope that is the context from which the search was
     * triggered.
     * </p>
     *
    ...
    /**
     * <p>
     * Searches for a symbol using the given query, using this
     * <code>Scope</code> as the source scope
     * of the search, i.e. the scope that is the context from which the search
     * was triggered. This
     * method works much like {@link #query(MultimatchSymbolQuery)} except that
     * it expects exactly one
     * match, as determined by the given query. If the given query matches more
     * than one entry, or
     * itself throws a {@link DuplicateSymbolException}, then this method will
     * throw a
     * <code>DuplicateSymbolException</code>.
     * </p>
     *
     ...
     */
    @Override
    public final <E extends SymbolTableEntry> E
            queryForOne(SymbolQuery<E> query)
    ...
    /**
     * <p>
     * Returns the parent scope that contains this scope.
     * </p>
     *
    ...
    /**
     * <p>
     * Returns the source repository that contains this scope.
     * </p>
     *
