 ...
 * that have a
 * performance profile with the specified operation name and the expected list
 * of parameter types.
 * </p>
 *
 * @version 2.0
...
public class OperationProfileSearcher
    ...
    /**
     * <p>
     * This constructs a searcher that specifies a search string for a
     * performance profile for an
     * operation and a list of program types for the operation.
     * </p>
     *
