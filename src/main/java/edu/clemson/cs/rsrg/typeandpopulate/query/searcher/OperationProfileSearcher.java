 ...
 * that have a performance profile with the specified operation name and the expected
 * list of parameter types.</p>
 *
 * @version 2.0
 */
public class OperationProfileSearcher
     ...
     * a performance profile for an operation and a list of program types
     * for the operation.</p>
     *
