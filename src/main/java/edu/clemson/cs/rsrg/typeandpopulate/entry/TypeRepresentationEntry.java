...
public class TypeRepresentationEntry extends SymbolTableEntry {
     ...
     * @param correspondence The mathematical correspondence expression for this
     *        entry.
     */
     ...
     * therefore this method returns a deep copy of the convention expression.
     * </p>
     *
     ...
     * Since this is used by multiple objects, we really don't want to be
     * returning a reference,
     * therefore this method returns a deep copy of the correspondence
     * expression.
     * </p>
     *
     * @return A {@link AssertionClause} representation object.
