 ...
 * defined in a {@code Concept Realization}.</p>
 *
 * @version 2.0
 */
public class TypeRepresentationEntry extends SymbolTableEntry {
    ...
    /** <p>The type family associated with this entry.</p> */
    private final TypeFamilyEntry myDefinition;

    /** <p>The program type used to implement this entry.</p> */
    ...
    /**
     * <p>This creates a symbol table entry for a type representation definition.</p>
     *
     ...
     * @param definition The type family associated with this entry.
     ...
     * @param correspondence The mathematical correspondence expression for this entry.
     */
    ...
    /**
     * <p>This method returns the program type used to implement this entry.</p>
     *
    ...
    public final ProgramTypeEntry toProgramTypeEntry(Location l) {
        return new ProgramTypeEntry(myRepresentation.getTypeGraph(), getName(),
