...
/**
 * <p>
 * A <code>ScopeRepository</code> maps {@link ResolveConceptualElement}s and
 * {@link ModuleIdentifier}s to the {@link Scope}s they introduce.
 * </p>
 *
 * <p>
 * Each <code>ScopeRepository</code> has a {@link TypeGraph} that relates the
 * types found in the
 * symbol table.
 * </p>
 *
