...
/**
 * <p>
 * This is an interface for all types of type comparisons that we might be
 * comparing during the type
 * and reasoning phase of the compiler.
 * </p>
 *
 * @version 2.0
 */
public interface TypeComparison<V extends Exp, T extends MTType> {
    ...
    /**
     * <p>
     * Takes an instance of {@link Exp} and use the {@link MTType} found in the
     * expression and compare
     * it with the expected {@link MTType}.
     * </p>
     *
     ...
     *
     * @return {@code true} if {@code foundType = expectedType}, {@code false}
     *         otherwise.
     */
