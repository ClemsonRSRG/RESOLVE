...
/**
 * <p>
 * An <code>InstantiatedScope</code> decorates an existing {@link Scope} such
 * that calls to
 * {@code addMatches}, the search method to which all others defer, are
...
public class InstantiatedScope extends AbstractScope {
    ...
    /**
     * <p>
     * This creates an instantiated scope for the generic
     * <code>baseScope</code>.
     * </p>
     *
     ...
     * @param instantiatingFacility The facility that is instantiating this
     *        scope.
     */
