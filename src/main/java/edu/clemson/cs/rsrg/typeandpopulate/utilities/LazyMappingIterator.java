...
/**
 * <p>
 * A <code>LazyMappingIterator</code> wraps an {@link Iterator} that iterates
 * over objects of type
 * <code>I</code> and presents an interface for mapping over objects of type
 * <code>O</code>. A
 * {@link Mapping} from <code>I</code> to <code>O</code> is used to transform
 * each object as it is
 * requested.
 * </p>
 * 
...
public final class LazyMappingIterator<I, O> implements Iterator<O> {
    ...
    /**
     * <p>
     * An iterator over <code>I</code> type objects.
     * </p>
     */
    ...
    /**
     * <p>
     * A mapping between two types of objects.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates an iterator over a mapping of objects.
     * </p>
     *
     ...
     * @throws ConcurrentModificationException if there is concurrent
     *         modification.
     */
    @Override
    public final O next() {
     ...
     * iterator (optional
     * operation). This method can be called only once per call to
     * {@link #next}. The behavior of an
