...
/**
 * <p>This class attempts to figure out either to use {@link QualifiedPath} when
 * a symbol is fully qualified or use {@link UnqualifiedPath} when it is not.</p>
 *
 * @version 2.0
 */
public class PossiblyQualifiedPath implements ScopeSearchPath {
    ...
    /** <p>This is the actual search path we are going to use.</p> */
    ...
    /**
     * <p>A search path for searching entries that could potentially be qualified.</p>
     *
     ...
     * <p>A search path for searching entries that could potentially be qualified.</p>
     *
     * <p><em>Note:</em> This search path uses {@code IMPORT_NONE} and {@code FACILITY_IGNORE}
     * strategies and local entries do not have priority.</p>
     *
     * @param qualifier A qualifier symbol that indicates the instantiating
     *                  facility or module.
     */
    ...
    /**
     * <p>A static helper method that helps this class decide either to use
     * a {@link QualifiedPath} or a {@link UnqualifiedPath} as its search path.</p>
     *
     * @param qualifier A qualifier symbol that indicates the instantiating
     *                  facility or module.
     * @param importStrategy The import strategy to use.
