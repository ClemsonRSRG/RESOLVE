...
/**
 * <p>This is the abstract base class for mutating bounded variables.</p>
 *
 * @version 2.0
 */
abstract class MutatingVisitor extends BoundVariableVisitor {
    ...
    /**
     * <p>The last type visited with the appropriate replacements
     * done by this visitor.</p>
     */
    private MTType myClosingType;

    /** <p>The resulting mathematical type.</p> */
    protected MTType myFinalExpression;

    /** <p>This stores the root mathematical type.</p> */
    private MTType myRoot;

    /** <p>A list containing a map of changes for each level of children nodes.</p> */
    private final LinkedList<Map<Integer, MTType>> myChangesAtLevel = new LinkedList<>();

    /** <p>A list of indices created during the visit.</p> */
     ...
     * a {@link MTType} by storing all the {@link MTType MTypes}
     * in {@code t}.</p>
     *
     * @param t A math type.
     */
     ...
     * the children of a {@link MTType} by replacing the
     * closing type.</p>
     *
     * @param t A math type.
     */
    ...
    /**
     * <p>This method adds additional logic after we visit
     * a {@link MTType} by removing all the items created
     * during the visit.</p>
     *
     * @param t A math type.
     */
    ...
    /**
     * <p>This method returns the final mathematical type
     * after all the changes are done.</p>
     *
    ...
    /**
     * <p>This method checks to see if we are at the root node.</p>
     *
    ...
    /**
     * <p>This method returns the current closing mathematical
     * type with the appropriate replacements.</p>
     *
