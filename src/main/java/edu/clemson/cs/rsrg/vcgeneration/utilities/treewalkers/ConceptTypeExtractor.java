...
/**
 * <p>
 * This class extracts all the {@link TypeFamilyDec} introduced by a
...
public class ConceptTypeExtractor extends TreeWalkerVisitor {
    ...
    /**
     * <p>
     * This creates an object that extracts all the {@link TypeFamilyDec} while
     * walking a
     * {@code Concept} module.
     * </p>
     */
    ...
    /**
     * <p>
     * This method returns the list of {@link TypeFamilyDec} that we encountered
     * after walking a
     * {@code Concept}.
     * </p>
     *
