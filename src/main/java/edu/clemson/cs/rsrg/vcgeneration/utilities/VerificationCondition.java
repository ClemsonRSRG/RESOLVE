...
/**
 * <p>
 * This class represents a possibly-named {@code verification condition}
 * ({@code VC}) represented by
 * a {@link Sequent}.
 * </p>
 *
 * @author Yu-Shan Sun
...
public class VerificationCondition implements BasicCapabilities, Cloneable {
    ...
    /**
     * <p>
     * A flag that indicates whether or not this {@link VerificationCondition}
     * contains a
     * {@link Sequent} that had an impacting reduction.
     * </p>
     */
    ...
    /**
     * <p>
     * An object that contains additional information on why the
     * {@code VCGenerator} generated this
     * {@code VC}. This model should come from the expressions that where
     * generated by applying the
     * various different {@code proof rules}.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates a {@code VC} with a name and it's associated
     * {@link Sequent}.
     * </p>
     *
     ...
     * @param hasImpactingReduction A flag that indicates whether or not this
     *        {@code VC} had an
     *        impacting reduced {@link Sequent}.
     * @param model The {@link LocationDetailModel} associated with this
     *        {@code VC}.
     */
    ...
    public final VerificationCondition clone() {
        return new VerificationCondition(myLocation.clone(), myName,
                mySequent.clone(), myHasImpactingReduction,
    ...
    /**
     * <p>
     * This method indicates if the {@link VerificationCondition} contains a
     * {@link Sequent} that had
     * an impacting reduction or not.
     * </p>
     *
     * @return {@code true} if we have applied some kind of logical reduction to
     *         one of the associated
     *         {@link Sequent Sequents}, {@code false} otherwise.
     */
