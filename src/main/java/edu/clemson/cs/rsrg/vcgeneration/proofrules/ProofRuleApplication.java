...
/**
 * <p>
 * A common interface that allows the different {@code Proof Rules} to be
 * applied.
 * </p>
 *
 * @author Yu-Shan Sun
...
public interface ProofRuleApplication {
    ...
    /**
     * <p>
     * This method returns the a {@link Deque} of {@link AssertiveCodeBlock
     * AssertiveCodeBlock(s)}
     * that resulted from applying the {@code Proof Rule}.
     * </p>
     *
     * @return A {@link Deque} containing all the {@link AssertiveCodeBlock
     *         AssertiveCodeBlock(s)}.
     */
    ...
    /**
     * <p>
     * This method returns the string template associated with the incoming
    ...
    /**
     * <p>
     * This method returns the a map containing the new string template block
     * models associated with
     * any {@link AssertiveCodeBlock AssertiveCodeBlock(s)} that resulted from
     * applying the
     * {@code Proof Rule}.
     * </p>
     *
