...
/**
 * <p>
 * This class contains the logic for applying the {@code function assignment}
 * rule.
 * </p>
 *
 * @author Yu-Shan Sun
...
public class FuncAssignStmtRule extends AbstractProofRuleApplication
     ...
     * </p>
     *
     * @param funcAssignStmt The {@link FuncAssignStmt} we are applying the rule
     *        to.
    ...
    public final void applyRule() {
        ...
        if (assignProgramExp instanceof ProgramFunctionExp) {
            ...
            Exp generatedRequires = walker
                    .getRequiresClause(assignProgramFunctionExp.getLocation());
            ...
            assignExp = Utilities.convertExp(assignProgramExp,
                    myCurrentModuleScope);
        }

        // Convert the left hand side into the expression we are going to substitute
        // with assignExp.
        Exp varExp = Utilities.convertExp(myFuncAssignStmt.getVariableExp(),
                myCurrentModuleScope);
