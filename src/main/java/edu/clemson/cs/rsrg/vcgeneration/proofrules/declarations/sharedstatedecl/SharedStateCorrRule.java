    ...
    public final void applyRule() {
        ...
        Exp topLevelAssumeExp =
                myCurrentVerificationContext.createTopLevelAssumeExpFromContext(
                        mySharedStateRealizationDec.getLocation(), true, false);
        ...
        // ( Confirm VC; )
        Exp sharedVariableConstraint = myCorrespondingSharedStateDec
                .getConstraint().getAssertionExp().clone();
        sharedVariableConstraint =
                sharedVariableConstraint.substitute(substitutionExemplarToConc);
        sharedVariableConstraint.setLocationDetailModel(new LocationDetailModel(
                myCorrespondingSharedStateDec.getLocation().clone(),
                mySharedStateRealizationDec.getLocation().clone(),
                "Well Defined Correspondence for Shared Variables"));
        ConfirmStmt finalConfirmStmt = new ConfirmStmt(
                mySharedStateRealizationDec.getLocation().clone(),
                sharedVariableConstraint,
                VarExp.isLiteralTrue(sharedVariableConstraint));
