 ...
 * </p>
 *
 * @see <a href="https://en.wikipedia.org/wiki/Sequent_calculus">Sequent
 *      Calculus</a>
 *
 * @author Yu-Shan Sun
 * @version 1.0
...
public class SequentReduction {
    ...
    /**
     * <p>
     * This method applies the various different sequent reduction rules until
     * we can't reduce any
     * further.
     * </p>
     *
            ...
            // rules to reduce it!
                ...
                if (leftReductionSeqs.isEmpty()) {
                    throw new SourceErrorException(
                            "[VCGenerator] Error encountered during reduction. Sequent: "
                                    + seq
                    ...
                    // reduction to be applied.
                        ...
                        Deque<Sequent> rightReductionSeqs =
                                applyRightReductionRules(resultSequent);
                        ...
                        if (rightReductionSeqs.isEmpty()) {
                            ...
                            if (myReductionTree.containsEdge(seq,
                                    resultSequent)) {
    ...
    /**
     * <p>
     * This method returns a map that indicates whether or not a {@link Sequent}
     * had an impacting
     * reduction.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns a graph containing the steps taken to reduce the
     * {@link Sequent}.
     * </p>
     *
    ...
    /**
     * <p>
     * An helper method that calls a reduction rule and adds the appropriate
     * nodes and edges to the
     * reduction tree.
     * </p>
     *
     * @param sequent The {@link Sequent} being reduced.
     * @param ruleApplication The {@link ReductionRuleApplication} to be
     *        applied.
     *
    ...
    private List<Sequent> applyAndAddToReductionTree(Sequent sequent,
        ...
        for (Sequent resultSeq : ruleResultingSeqs) {
            ...
            if (myImpactingReducedSequentMap.get(sequent)) {
                ...
                myImpactingReducedSequentMap.put(resultSeq,
                        ruleApplication.isIsImpactingReductionFlag());
            }
        }
    ...
    /**
     * <p>
     * This method attempts to apply the left reduction rules to
     * {@code sequent}.
     * </p>
     *
    ...
    private Deque<Sequent> applyLeftReductionRules(Sequent sequent) {
        ...
        while (antecedentsIt.hasNext() && !doneReduction) {
            ...
            if (ruleApplication != null) {
                ...
                resultingSeq.addAll(
                        applyAndAddToReductionTree(sequent, ruleApplication));
                doneReduction = true;
            }
        }
    ...
    /**
     * <p>
     * This method attempts to apply the right reduction rules to
     * {@code sequent}.
     * </p>
     *
     * @param sequent The sequent to be reduced.
