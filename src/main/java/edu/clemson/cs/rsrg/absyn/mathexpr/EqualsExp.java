...
public class EqualsExp extends AbstractFunctionExp {
    ...
    @Override
    protected Exp copy() {
        return new EqualsExp(new Location(myLoc), myQualifier.clone(),
                myLeftHandSide.clone(), myOperator, myRightHandSide.clone());
    }
    ...
    protected Exp substituteChildren(Map<Exp, Exp> substitutions) {
        return new EqualsExp(new Location(myLoc), myQualifier.clone(),
                substitute(myLeftHandSide, substitutions), myOperator,
