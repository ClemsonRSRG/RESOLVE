 ...
 * 
 * <ul>
 * <li>Inside the hierarchy of an {@link ArbitraryExpTy} when that ty appears in
 * the context of the
 * type of a formal parameter to a mathematical definition.</li>
 * <li>Inside a {@link MathTypeTheoremDec}, either at the top level of the
 * overall assertion, or at
 * the top level of the consequent of a top-level <em>implies</em>
 * expression.</li>
 * </ul>
 * 
 * <p>
 ...
 * of the type of the
 * actual parameter. In this case, the expression must be a {@link VarExp}. Some
 * examples:
 * </p>
 * 
 * <pre>
...
public class TypeAssertionExp extends MathExp {
    ...
    protected final Exp substituteChildren(Map<Exp, Exp> substitutions) {
        return new TypeAssertionExp(cloneLocation(),
                substitute(myExp, substitutions),
