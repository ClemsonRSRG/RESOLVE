...
/**
 * <p>
 * This is the class for all the procedure declaration objects that the compiler
 * builds using the
 * ANTLR4 AST nodes.
 * </p>
 *
...
public class ProcedureDec extends Dec {
     ...
     * </p>
     *
     * @param name A {@link PosSymbol} representing the procedure's name.
     * @param parameters A list of {@link ParameterVarDec} representing the
     *        procedure's parameter
     *        variables.
     * @param returnTy A {@link Ty} representing the procedure's return value
     *        type.
    ...
    /**
     * <p>
     * This method returns the list of facility declarations for this procedure
     * declaration.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the list of statements in for this procedure
     * declaration.
     * </p>
     *
