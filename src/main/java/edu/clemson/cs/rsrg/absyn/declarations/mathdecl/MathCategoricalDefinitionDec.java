...
/**
 * <p>
 * This is the class for all the mathematical categorical definition
...
public class MathCategoricalDefinitionDec extends Dec {
     ...
     * @param definitions List of definitions inside this categorical
     *        definition.
    ...
    public final String asString(int indentSize, int innerIndentInc) {
        ...
        while (it.hasNext()) {
            ...
            sb.append(definitionDec.getName()
    ...
    /**
     * <p>
     * This method returns all the expression relating all the definitions in
     * this categorical
     * definition.
     * </p>
     *
    ...
    protected final MathCategoricalDefinitionDec copy() {
        ...
        return new MathCategoricalDefinitionDec(myName.clone(), newDefinitions,
                myRelatedByExp.clone());
    }
}
