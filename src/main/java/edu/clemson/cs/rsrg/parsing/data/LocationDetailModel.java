...
/**
 * <p>
 * This class is an helper class that stores both source and destination
 * {@link Location Locations}
 * as well as the associated message of where an {@link Exp} got generated by
 * the
 * {@link VCGenerator}.
 * </p>
 *
...
public class LocationDetailModel implements Cloneable {
    ...
    /**
     * <p>
     * The destination {@link Location} where we want the detail message to be
     * displayed at.
     * </p>
     */
    ...
    /**
     * <p>
     * This creates an object that stores the source and destination locations
     * that generated the
     * associated {@link Exp}. The message is used by the {@link VCGenerator}
     ...
     * {@link LocationDetailModel} class.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the location to be displayed by the
     * {@link VCGenerator}.
     * </p>
     *
    ...
    /**
     * <p>
     * This method returns the message associated with the destination
     * {@link Location}.
     * </p>
     *
     * @return A string.
    ...
    /**
     * <p>
     * This method returns the source location where an {@link Exp} originated
     * from.
     * </p>
     *
     * @return A {@link Location}.
