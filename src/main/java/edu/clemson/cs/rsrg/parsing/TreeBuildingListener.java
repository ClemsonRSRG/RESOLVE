...
public class TreeBuildingListener extends ResolveParserBaseListener {
     ...
     * generated by its child rules.</p>
     *
     * @param ctx Program dot array expression node in ANTLR4 AST.
     */
    @Override
    public void exitProgDotArrayExp(ResolveParser.ProgDotArrayExpContext ctx) {
        // TODO: Migrate VariableArrayExp conversions logic from PreProcessor.
        super.exitProgDotArrayExp(ctx);
    }
    ...
    public void exitProgVarDotArrayExp(
            ResolveParser.ProgVarDotArrayExpContext ctx) {
        super.exitProgVarDotArrayExp(ctx);
    }
