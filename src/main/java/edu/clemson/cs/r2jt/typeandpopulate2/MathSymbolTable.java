...
import edu.clemson.cs.r2jt.absynnew.ModuleAST.PrecisAST;
 ...
 * those nodes in the AST that define a scope to {@link FinalizedScope Scope}
 * objects representing those scopes and containing the symbols defined
 * therein.</p>
 *
 * <p><code>Scope</code>s that were introduced at the module-level (e.g.,
 * the scope defined by a {@link PrecisAST}) will have an
 * associated <code>Scope</code> that is further refined into an instance of
 * {@link ModuleScope}.  As a convenience, such module scopes may be retrieved
 * in a type-safe way with {@link #getModuleScope(ModuleIdentifier)}.</p>
 *
...
public class MathSymbolTable extends ScopeRepository {
    ...
    private final Map<ResolveAST, FinalizedScope> myScopes =
            new HashMap<ResolveAST, FinalizedScope>();
    ...
    private void seal(ScopeBuilder b, List<ImportRequest> importedModules) {
        ...
        ResolveAST definingElement = b.getDefiningElement();
        if (definingElement != null) {
            ...
            if (result instanceof FinalizedModuleScope) {
                ...
                resultIdentifier =
                        new ModuleIdentifier((ModuleAST) b.getDefiningElement());
     ...
     * there is not associated scope, throws a {@link NoSuchScopeException}.</p>
     *
     ...
     */
    public FinalizedScope getScope(ResolveAST e) {
     ...
     *
     * @param module The node in the AST for which to retrieve an associated
     *          <code>Scope</code>.
     *
     * @return The associated scope.
     *
