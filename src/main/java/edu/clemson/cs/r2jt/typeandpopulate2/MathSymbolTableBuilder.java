 ...
 * {@link edu.clemson.cs.r2jt.typeandpopulate.MathSymbolTable MathSymbolTable}s.  It's behavior directly mirrors
...
public class MathSymbolTableBuilder extends ScopeRepository {
    ...
    private final Map<ResolveAST, ScopeBuilder> myScopes =
            new HashMap<ResolveAST, ScopeBuilder>();
     ...
     *
     * @param definingElement The {@link ModuleAST} defining this scope.
     *
     ...
     *             <code>null</code>.
     */
    public ModuleScopeBuilder startModuleScope(ModuleAST definingElement) {
    ...
    public ScopeBuilder getScope(ResolveAST e) {
     ...
     * @throws IllegalStateException If no module scope is currently open.
     */
    public ScopeBuilder startScope(ResolveAST definingElement) {
