 ...
 */
public class NormalizedAtomicExpressionMapImpl implements Comparable<NormalizedAtomicExpressionMapImpl> {
    ...
    public int readPosition(int position) {
        ...
        for (Map.Entry<Integer, Integer> e : entries) {
            if ((e.getValue() & position) != 0) return e.getKey();
