...
public class PAlternatives extends PExp {
	...
	public PAlternatives(AlternativeExp alternativeExp, 
		...
		this (getConditions(alternativeExp, typer), 
				getResults(alternativeExp, typer),
				getOtherwiseClauseResult(alternativeExp, typer),
				typer);
	}
	...
	private static PExp getOtherwiseClauseResult(
				AlternativeExp alternativeExp, MathExpTypeResolver typer) {
