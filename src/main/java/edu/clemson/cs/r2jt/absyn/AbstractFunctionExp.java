...
public abstract class AbstractFunctionExp extends Exp {
     ...
     * 1: result =
     * params.get(0); break; default: java.util.List<MTType> componentTypes =
     * new
     * LinkedList<MTType>(); TupleExp tuple = new TupleExp(l, params); for (Exp
     * param : params) {
     * componentTypes.add(param.getMathType()); } MTType tupleType =
     * MTFunction.buildParameterType(g,
     * componentTypes);
     * 
