...
/**
 * <p>
 * A <code>PExpSubexpressionIterator</p> defines the interface for classes
...
public interface PExpSubexpressionIterator {
    ...
    /**
     * <p>
     * Returns <code>true</code> <strong>iff</strong> there are additional
     * subexpressions. I.e.,
     * returns <code>true</code> <strong>iff</strong> <code>next()</code> would
     * return an element
    ...
    /**
     * </p>
     * Returns the next subexpression./p>
     * 
    ...
    /**
     * <p>
     * Returns a version of the original <code>PExp</code> (i.e., the
     * <code>PExp</code> over whose
     * subexpressions we are iterating) with the subexpression most recently
     * returned by
     * <code>next()</code> replaced with <code>newExpression</code>.
     * </p>
     * 
