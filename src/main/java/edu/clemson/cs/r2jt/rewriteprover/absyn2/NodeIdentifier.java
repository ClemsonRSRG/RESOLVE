...
public class NodeIdentifier implements Iterable<Integer> {
    ...
    private final PExpr myPExp;

    public NodeIdentifier(PExpr pexp) {
        myPExp = pexp;
        myHash = pexp.hashCode();
    }

    public NodeIdentifier(PExpr pexp, Iterable<Integer> source) {
        myHash = pexp.hashCode();
    ...
    public NodeIdentifier(PExpr pexp, int[] source) {
        myHash = pexp.hashCode();
    ...
    public NodeIdentifier(PExpr pexp, int[] source, int offset, int length) {
        myHash = pexp.hashCode();
