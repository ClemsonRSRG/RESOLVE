...
/**
 * <p>
 * A <code>SymbolQuery</code> defines a strategy for returning a list of
 * {@link SymbolTableEntry
 * SymbolTableEntry}s that meet a certain set of criteria starting from some
 * <em>source scope</em>.
 */
public interface SymbolQuery<E extends SymbolTableEntry> {
    ...
    /**
     * <p>
     * Given a source {@link Scope Scope} and a {@link ScopeRepository
     * ScopeRepository} containing any
     * imports, from which <code>source</code> is drawn, searches them
     * appropriately, returning a list
     * of matching {@link SymbolTableEntry SymbolTableEntry}s that are subtypes
     * of <code>E</code>.
     * </p>
     * 
     * <p>
