...
/**
 * <p>
 * A <code>ScopeSearchPath</code> defines which {@link Scope Scope}s should be
 * searched for symbol
 * table matches and in what order.
 * </p>
 * 
 * <p>
 ...
 * 
 * <p>
 * Given a {@link TableSearcher TableSearcher}, a source scope, and a
 * {@link ScopeRepository
 * ScopeRepository} containing any imports, a <code>ScopeSearchPath</code> will
 * apply the
 * <code>TableSearcher</code> appropriately to any <code>Scope</code>s that
 * should be searched.
 * </p>
 */
public interface ScopeSearchPath {
    ...
    /**
     * <p>
     * Applies the given {@link TableSearcher TableSearcher} to the appropriate
     * {@link Scope Scope}s,
     * given a source scope and a {@link ScopeRepository ScopeRepository}
     * containing any imports,
