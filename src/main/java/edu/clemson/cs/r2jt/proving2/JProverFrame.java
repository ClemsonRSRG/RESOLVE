...
public class JProverFrame extends JFrame {
	...
	public static void main(String[] args) throws FlagDependencyException {
		...
		MathExpTypeResolver metr = new MathExpTypeResolver(null, null, new CompileEnvironment(args));
		...
		conjuncts.add(new PSymbol(BooleanType.INSTANCE, "=", expArgs, PSymbol.DisplayType.INFIX, metr));
		
		expArgs.clear();
		expArgs.add(new PSymbol(BooleanType.INSTANCE, "z", metr));
		
		conjuncts.add(new PSymbol(BooleanType.INSTANCE, "not", expArgs, PSymbol.DisplayType.PREFIX, metr));
		...
		PExp first = new PSymbol(BooleanType.INSTANCE, "+", expArgs, PSymbol.DisplayType.INFIX, metr);
		
		expArgs.clear();
		expArgs.add(new PSymbol(BooleanType.INSTANCE, "a", metr));
		expArgs.add(first);
		
		PExp cc = new PSymbol(BooleanType.INSTANCE, "*", expArgs, PSymbol.DisplayType.INFIX, metr);
		conjuncts.add(cc);
