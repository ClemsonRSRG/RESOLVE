...
/**
 * <p>
 * Unit test for making sure that all the {@link MathExp MathExps} implement
 * {@link MathExp#equivalent(Exp)}.
 * </p>
 *
 * @author Yu-Shan Sun
 * @version 1.0
...
public class ExpEquivalenceTest {
    ...
    /**
     * <p>
     * A fake {@link Location} object to be used to create
    ...
    /**
     * <p>
     * Another fake {@link Location} object to be used to create
     * {@link ResolveConceptualElement
     * ResolveConceptualElements}.
     * </p>
     */
    ...
    /**
     * <p>
     * A fake {@link LocationDetailModel} object to be used to create
     * {@link ResolveConceptualElement
     * ResolveConceptualElements}.
     * </p>
     */
    ...
    /**
     * <p>
     * Another fake {@link LocationDetailModel} object to be used to create
     * {@link ResolveConceptualElement ResolveConceptualElements}.
     * </p>
     */
    ...
    /**
     * <p>
     * A fake {@link TypeGraph} object that allows us to assign types to
     * expressions.
     * </p>
     */
    ...
    {
        try {
            FAKE_LOCATION_1 = new Location(new ResolveFile(
                    new ResolveFileBasicInfo("ExpEquivalenceTest", ""),
                    ModuleType.THEORY,
                    new UnbufferedCharStream(new StringReader("")), null,
            ...
            FAKE_LOCATION_2 = new Location(new ResolveFile(
                    new ResolveFileBasicInfo("ExpEquivalenceTest", ""),
                    ModuleType.THEORY,
                    new UnbufferedCharStream(new StringReader("")), null,
            ...
            FAKE_TYPEGRAPH = new TypeGraph(new CompileEnvironment(new String[0],
    ...
    /**
     * <p>
     * This tests {@link AlternativeExp#equals(Object)},
     * {@link AlternativeExp#equivalent(Exp)},
    ...
    public final void testAlternativeExpressions() {
        ...
        AltItemExp altItemExp1 = new AltItemExp(FAKE_LOCATION_1.clone(),
                ...
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "B")));
        altItemExp1
        ...
        AltItemExp altItemExp2 = new AltItemExp(FAKE_LOCATION_2.clone(),
                ...
                new VarExp(FAKE_LOCATION_2.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "B")));
        altItemExp2
        ...
        AlternativeExp alternativeExp1 =
                new AlternativeExp(FAKE_LOCATION_1.clone(),
                        Arrays.asList(altItemExp1, otherwiseExp));
        alternativeExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        AlternativeExp alternativeExp2 =
                new AlternativeExp(FAKE_LOCATION_2.clone(),
                        Arrays.asList(altItemExp1, otherwiseExp));
        alternativeExp2
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());
    ...
    /**
     * <p>
     * This tests {@link BetweenExp#equals(Object)}} and
     * {@link BetweenExp#equivalent(Exp)}.
     * </p>
     */
    @Test
        ...
        BetweenExp betweenExp1 = new BetweenExp(FAKE_LOCATION_1.clone(),
                Arrays.<Exp> asList(
                        MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(),
                                FAKE_TYPEGRAPH),
                        MathExp.getFalseVarExp(FAKE_LOCATION_1.clone(),
                                FAKE_TYPEGRAPH)));
        betweenExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());
        ...
        BetweenExp betweenExp2 = new BetweenExp(FAKE_LOCATION_2.clone(),
                Arrays.<Exp> asList(
                        MathExp.getTrueVarExp(FAKE_LOCATION_2.clone(),
                                FAKE_TYPEGRAPH),
                        MathExp.getFalseVarExp(FAKE_LOCATION_2.clone(),
                                FAKE_TYPEGRAPH)));
        betweenExp2
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());
    ...
    /**
     * <p>
     * This tests {@link DotExp#equals(Object)}} and
     * {@link DotExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * This tests {@link FunctionExp#equals(Object)}} and
     * {@link FunctionExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testFunctionExpressions() {
        // FunctionExp
        FunctionExp functionExp1 = new FunctionExp(
                FAKE_LOCATION_1.clone(), new VarExp(FAKE_LOCATION_1.clone(),
        ...
        FunctionExp functionExp2 = new FunctionExp(
                FAKE_LOCATION_2.clone(), new VarExp(FAKE_LOCATION_2.clone(),
    ...
    /**
     * <p>
     * This tests {@link InfixExp#equals(Object)}},
     * {@link InfixExp#equivalent(Exp)},
     * {@link EqualsExp#equals(Object)}} and {@link EqualsExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testInfixExpressions() {
        ...
        InfixExp infixExp1 = new InfixExp(FAKE_LOCATION_1.clone(),
                MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH),
                null, new PosSymbol(FAKE_LOCATION_1.clone(), "<="),
                MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH));
    ...
    /**
     * <p>
     * This tests {@link IterativeExp#equals(Object)}} and
     * {@link IterativeExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testIterativeExpressions() {
        // IterativeExp
        IterativeExp iterativeExp1 = new IterativeExp(FAKE_LOCATION_1.clone(),
                IterativeExp.Operator.CONCATENATION,
                new MathVarDec(new PosSymbol(FAKE_LOCATION_1.clone(), "a"),
                        new NameTy(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(),
                                        "Integer"))),
                null,
                new EqualsExp(FAKE_LOCATION_1.clone(),
                        MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(),
                                FAKE_TYPEGRAPH),
                        null, EqualsExp.Operator.NOT_EQUAL,
                        MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(),
        ...
        IterativeExp iterativeExp2 = new IterativeExp(FAKE_LOCATION_2.clone(),
                IterativeExp.Operator.CONCATENATION,
                new MathVarDec(new PosSymbol(FAKE_LOCATION_2.clone(), "a"),
                        new NameTy(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(),
                                        "Integer"))),
                null,
                new EqualsExp(FAKE_LOCATION_2.clone(),
                        MathExp.getTrueVarExp(FAKE_LOCATION_2.clone(),
                                FAKE_TYPEGRAPH),
                        null, EqualsExp.Operator.NOT_EQUAL,
                        MathExp.getTrueVarExp(FAKE_LOCATION_2.clone(),
    ...
    /**
     * <p>
     * This tests {@link LambdaExp#equals(Object)}} and
     * {@link LambdaExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testLambdaExpressions() {
        ...
        LambdaExp lambdaExp1 = new LambdaExp(FAKE_LOCATION_1.clone(),
                Collections.singletonList(new MathVarDec(
    ...
    /**
     * <p>
     * This tests {@link LiteralExp#equals(Object)}} and
     * {@link LiteralExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * This tests {@link OldExp#equals(Object)}} and
     * {@link OldExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * This tests {@link OutfixExp#equals(Object)}} and
     * {@link OutfixExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testOutfixExpressions() {
        // OutfixExp
        OutfixExp outfixExp1 = new OutfixExp(FAKE_LOCATION_1.clone(),
                OutfixExp.Operator.DBL_ANGLE,
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "C")));
        outfixExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        OutfixExp outfixExp2 = new OutfixExp(FAKE_LOCATION_2.clone(),
                OutfixExp.Operator.DBL_ANGLE,
                new VarExp(FAKE_LOCATION_2.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "C")));
    ...
    /**
     * <p>
     * This tests {@link PrefixExp#equals(Object)}} and
     * {@link PrefixExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testPrefixExpressions() {
        // PrefixExp
        PrefixExp prefixExp1 = new PrefixExp(FAKE_LOCATION_1.clone(), null,
                new PosSymbol(null, "Operator"),
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "C")));
        prefixExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        PrefixExp prefixExp2 = new PrefixExp(FAKE_LOCATION_2.clone(), null,
                new PosSymbol(null, "Operator"),
                new VarExp(FAKE_LOCATION_2.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "C")));
    ...
    /**
     * <p>
     * This tests {@link QuantExp#equals(Object)}} and
     * {@link QuantExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testQuantifiedExpressions() {
        // QuantExp
        QuantExp quantExp1 = new QuantExp(FAKE_LOCATION_1.clone(),
        ...
        QuantExp quantExp2 = new QuantExp(FAKE_LOCATION_2.clone(),
                SymbolTableEntry.Quantification.EXISTENTIAL,
                Collections.singletonList(new MathVarDec(
                        new PosSymbol(FAKE_LOCATION_2.clone(), "a"),
                        new NameTy(FAKE_LOCATION_2.clone(), null,
    ...
    /**
     * <p>
     * This tests {@link RecpExp#equals(Object)}},
     * {@link RecpExp#equivalent(Exp)},
     * {@link TypeReceptaclesExp#equals(Object)} and
     * {@link TypeReceptaclesExp#equivalent(Exp)}}.
     * </p>
     */
    @Test
    public final void testReceptaclesExpressions() {
        ...
        RecpExp recpExp1 = new RecpExp(FAKE_LOCATION_1.clone(),
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "S")));
        recpExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        RecpExp recpExp2 = new RecpExp(FAKE_LOCATION_2.clone(),
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "S")));
        recpExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());

        assertionCheck(recpExp1, recpExp2);

        // TypeReceptaclesExp
        TypeReceptaclesExp typeReceptaclesExp1 = new TypeReceptaclesExp(
                FAKE_LOCATION_1.clone(),
                new VarExp(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "Integer")));
        typeReceptaclesExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        TypeReceptaclesExp typeReceptaclesExp2 = new TypeReceptaclesExp(
                FAKE_LOCATION_2.clone(),
                new VarExp(FAKE_LOCATION_2.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "Integer")));
        typeReceptaclesExp2
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());
    ...
    /**
     * <p>
     * This tests {@link SetCollectionExp#equals(Object)}} and
     * {@link SetCollectionExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testSetCollectionExpressions() {
        // SetCollectionExp
        SetCollectionExp setCollectionExp1 = new SetCollectionExp(
                FAKE_LOCATION_1.clone(),
        ...
        SetCollectionExp setCollectionExp2 = new SetCollectionExp(
                FAKE_LOCATION_2.clone(),
                new HashSet<>(Arrays.<MathExp> asList(
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "C")),
        ...
        SetCollectionExp setCollectionExp3 = new SetCollectionExp(
                FAKE_LOCATION_2.clone(),
                new HashSet<>(Arrays.<MathExp> asList(
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "D")),
    ...
    /**
     * <p>
     * This tests {@link SetExp#equals(Object)}} and
     * {@link SetExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testSetExpressions() {
        // SetExp
        SetExp setExp1 = new SetExp(FAKE_LOCATION_1.clone(), new MathVarDec(
                new PosSymbol(FAKE_LOCATION_1.clone(), "a"),
                new NameTy(FAKE_LOCATION_1.clone(), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "Integer"))),
                null,
        ...
        SetExp setExp2 = new SetExp(FAKE_LOCATION_2.clone(), new MathVarDec(
                new PosSymbol(FAKE_LOCATION_2.clone(), "a"),
                new NameTy(FAKE_LOCATION_2.clone(), null,
                        new PosSymbol(FAKE_LOCATION_2.clone(), "Integer"))),
                null,
    ...
    /**
     * <p>
     * This tests {@link TupleExp#equals(Object)}} and
     * {@link TupleExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    ...
    /**
     * <p>
     * This tests {@link UnaryMinusExp#equals(Object)}} and
     * {@link UnaryMinusExp#equivalent(Exp)}.
     * </p>
     */
    @Test
    public final void testUnaryMinusExpressions() {
        ...
        UnaryMinusExp unaryMinusExp1 =
                new UnaryMinusExp(FAKE_LOCATION_1.clone(),
                        new IntegerExp(FAKE_LOCATION_1.clone(), null, 1));
        unaryMinusExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        UnaryMinusExp unaryMinusExp2 =
                new UnaryMinusExp(FAKE_LOCATION_2.clone(),
    ...
    /**
     * <p>
     * This tests {@link VarExp#equals(Object)}},
     * {@link VarExp#equivalent(Exp)},
     * {@link VCVarExp#equals(Object)} and {@link VCVarExp#equivalent(Exp)}}.
     * </p>
     */
    @Test
    public final void testVarExpressions() {
        // VarExp
        VarExp varExp1 = new VarExp(FAKE_LOCATION_1.clone(), null,
                new PosSymbol(FAKE_LOCATION_1.clone(), "C"));
        varExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        VarExp varExp2 = new VarExp(FAKE_LOCATION_2.clone(), null,
                new PosSymbol(FAKE_LOCATION_2.clone(), "C"));
