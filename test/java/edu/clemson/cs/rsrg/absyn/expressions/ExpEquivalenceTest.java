...
public class ExpEquivalenceTest {
    ...
    /**
     * <p>This tests {@link AlternativeExp#equals(Object)},
     * {@link AlternativeExp#equivalent(Exp)}, {@link AltItemExp#equals(Object)}
     * and {@link AltItemExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testAlternativeExpressions() {
        ...
        AlternativeExp alternativeExp2 =
                new AlternativeExp(FAKE_LOCATION_2.clone(), Arrays.asList(
                        altItemExp1, otherwiseExp));
        alternativeExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2
                .clone());
    ...
    /**
     * <p>This tests {@link BetweenExp#equals(Object)}} and
     * {@link BetweenExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testBetweenExpressions() {
        // BetweenExp
        BetweenExp betweenExp1 =
                new BetweenExp(FAKE_LOCATION_1.clone(), Arrays.<Exp> asList(
                        MathExp.getTrueVarExp(FAKE_LOCATION_1.clone(),
                                FAKE_TYPEGRAPH), MathExp.getFalseVarExp(
                                FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH)));
        betweenExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        BetweenExp betweenExp2 =
                new BetweenExp(FAKE_LOCATION_2.clone(), Arrays.<Exp> asList(
                        MathExp.getTrueVarExp(FAKE_LOCATION_2.clone(),
                                FAKE_TYPEGRAPH), MathExp.getFalseVarExp(
                                FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH)));
        betweenExp2
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());
    ...
    /**
     * <p>This tests {@link DotExp#equals(Object)}} and
     * {@link DotExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testDotExpressions() {
        // DotExp
        DotExp dotExp1 =
                new DotExp(FAKE_LOCATION_1.clone(), Arrays.<Exp> asList(
                        new VarExp(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(), "C")),
                        new VarExp(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(), "D"))));
        dotExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        DotExp dotExp2 =
                new DotExp(FAKE_LOCATION_2.clone(), Arrays.<Exp> asList(
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "C")),
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "D"))));
    ...
    /**
     * <p>This tests {@link FunctionExp#equals(Object)}} and
     * {@link FunctionExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testFunctionExpressions() {
        // FunctionExp
        FunctionExp functionExp1 =
                new FunctionExp(FAKE_LOCATION_1.clone(), new VarExp(
                        FAKE_LOCATION_1.clone(), null, new PosSymbol(
                                FAKE_LOCATION_1.clone(), "C")), null, Arrays
                        .<Exp> asList(MathExp.getTrueVarExp(FAKE_LOCATION_1
                                .clone(), FAKE_TYPEGRAPH), MathExp
                                .getFalseVarExp(FAKE_LOCATION_1.clone(),
                                        FAKE_TYPEGRAPH)));
        functionExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1
                .clone());

        FunctionExp functionExp2 =
                new FunctionExp(FAKE_LOCATION_2.clone(), new VarExp(
                        FAKE_LOCATION_2.clone(), null, new PosSymbol(
                                FAKE_LOCATION_2.clone(), "C")), null, Arrays
                        .<Exp> asList(MathExp.getTrueVarExp(FAKE_LOCATION_2
                                .clone(), FAKE_TYPEGRAPH), MathExp
                                .getFalseVarExp(FAKE_LOCATION_2.clone(),
                                        FAKE_TYPEGRAPH)));
        functionExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2
                .clone());
    ...
    /**
     * <p>This tests {@link InfixExp#equals(Object)}},
     * {@link InfixExp#equivalent(Exp)}, {@link EqualsExp#equals(Object)}} and
     * {@link EqualsExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testInfixExpressions() {
        // InfixExp
        InfixExp infixExp1 =
                new InfixExp(FAKE_LOCATION_1.clone(), MathExp.getTrueVarExp(
                        FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH), null,
                        new PosSymbol(FAKE_LOCATION_1.clone(), "<="), MathExp
                                .getTrueVarExp(FAKE_LOCATION_1.clone(),
                                        FAKE_TYPEGRAPH));
        ...
        // EqualsExp
        EqualsExp equalsExp1 =
                new EqualsExp(FAKE_LOCATION_1.clone(), MathExp.getTrueVarExp(
                        FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH));
        equalsExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        EqualsExp equalsExp2 =
                new EqualsExp(FAKE_LOCATION_2.clone(), MathExp.getTrueVarExp(
                        FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH));
        ...
        EqualsExp notEqualsExp1 =
                new EqualsExp(FAKE_LOCATION_1.clone(), MathExp.getTrueVarExp(
                        FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.NOT_EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH));
        notEqualsExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1
                .clone());

        EqualsExp notEqualsExp2 =
                new EqualsExp(FAKE_LOCATION_2.clone(), MathExp.getTrueVarExp(
                        FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.NOT_EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH));
        notEqualsExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2
                .clone());
    ...
    /**
     * <p>This tests {@link IterativeExp#equals(Object)}} and
     * {@link IterativeExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testIterativeExpressions() {
        // IterativeExp
        IterativeExp iterativeExp1 =
                new IterativeExp(FAKE_LOCATION_1.clone(),
                        IterativeExp.Operator.CONCATENATION, new MathVarDec(
                                new PosSymbol(FAKE_LOCATION_1.clone(), "a"),
                                new NameTy(FAKE_LOCATION_1.clone(), null,
                                        new PosSymbol(FAKE_LOCATION_1.clone(),
                                                "Integer"))), null,
                        new EqualsExp(FAKE_LOCATION_1.clone(), MathExp
                                .getTrueVarExp(FAKE_LOCATION_1.clone(),
                                        FAKE_TYPEGRAPH), null,
                                EqualsExp.Operator.NOT_EQUAL, MathExp
                                        .getTrueVarExp(FAKE_LOCATION_1.clone(),
                                                FAKE_TYPEGRAPH)));
        iterativeExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1
                .clone());

        IterativeExp iterativeExp2 =
                new IterativeExp(FAKE_LOCATION_2.clone(),
                        IterativeExp.Operator.CONCATENATION, new MathVarDec(
                                new PosSymbol(FAKE_LOCATION_2.clone(), "a"),
                                new NameTy(FAKE_LOCATION_2.clone(), null,
                                        new PosSymbol(FAKE_LOCATION_2.clone(),
                                                "Integer"))), null,
                        new EqualsExp(FAKE_LOCATION_2.clone(), MathExp
                                .getTrueVarExp(FAKE_LOCATION_2.clone(),
                                        FAKE_TYPEGRAPH), null,
                                EqualsExp.Operator.NOT_EQUAL, MathExp
                                        .getTrueVarExp(FAKE_LOCATION_2.clone(),
                                                FAKE_TYPEGRAPH)));
        iterativeExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2
                .clone());
    ...
    /**
     * <p>This tests {@link LambdaExp#equals(Object)}} and
     * {@link LambdaExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testLambdaExpressions() {
        // LambdaExp
        LambdaExp lambdaExp1 =
                new LambdaExp(FAKE_LOCATION_1.clone(), Collections
                        .singletonList(new MathVarDec(new PosSymbol(
                                FAKE_LOCATION_1.clone(), "a"), new NameTy(
                                FAKE_LOCATION_1.clone(), null, new PosSymbol(
        ...
        LambdaExp lambdaExp2 =
                new LambdaExp(FAKE_LOCATION_2.clone(), Collections
                        .singletonList(new MathVarDec(new PosSymbol(
                                FAKE_LOCATION_2.clone(), "a"), new NameTy(
                                FAKE_LOCATION_2.clone(), null, new PosSymbol(
    ...
    /**
     * <p>This tests {@link LiteralExp#equals(Object)}} and
     * {@link LiteralExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testLiteralExpressions() {
        ...
        // IntegerExp
        IntegerExp integerExp1 =
                new IntegerExp(FAKE_LOCATION_1.clone(), null, 5);
        integerExp1
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        IntegerExp integerExp2 =
                new IntegerExp(FAKE_LOCATION_2.clone(), null, 5);
        integerExp2
                .setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2.clone());
    ...
    /**
     * <p>This tests {@link OldExp#equals(Object)}} and
     * {@link OldExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testOldExpressions() {
        // OldExp
        OldExp oldExp1 =
                new OldExp(FAKE_LOCATION_1.clone(), new VarExp(FAKE_LOCATION_1
                        .clone(), null, new PosSymbol(FAKE_LOCATION_1.clone(),
                        "C")));
        oldExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        OldExp oldExp2 =
                new OldExp(FAKE_LOCATION_2.clone(), new VarExp(FAKE_LOCATION_2
    ...
    /**
     * <p>This tests {@link OutfixExp#equals(Object)}} and
     * {@link OutfixExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testOutfixExpressions() {
        // OutfixExp
        OutfixExp outfixExp1 =
                new OutfixExp(FAKE_LOCATION_1.clone(),
                        OutfixExp.Operator.DBL_ANGLE, new VarExp(
                                FAKE_LOCATION_1.clone(), null, new PosSymbol(
                                        FAKE_LOCATION_1.clone(), "C")));
        outfixExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        OutfixExp outfixExp2 =
                new OutfixExp(FAKE_LOCATION_2.clone(),
                        OutfixExp.Operator.DBL_ANGLE, new VarExp(
                                FAKE_LOCATION_2.clone(), null, new PosSymbol(
    ...
    /**
     * <p>This tests {@link PrefixExp#equals(Object)}} and
     * {@link PrefixExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testPrefixExpressions() {
        // PrefixExp
        PrefixExp prefixExp1 =
                new PrefixExp(FAKE_LOCATION_1.clone(), null, new PosSymbol(
                        null, "Operator"), new VarExp(FAKE_LOCATION_1.clone(),
                        null, new PosSymbol(FAKE_LOCATION_1.clone(), "C")));
        prefixExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1.clone());

        PrefixExp prefixExp2 =
                new PrefixExp(FAKE_LOCATION_2.clone(), null, new PosSymbol(
                        null, "Operator"), new VarExp(FAKE_LOCATION_2.clone(),
                        null, new PosSymbol(FAKE_LOCATION_2.clone(), "C")));
    ...
    /**
     * <p>This tests {@link QuantExp#equals(Object)}} and
     * {@link QuantExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testQuantifiedExpressions() {
        // QuantExp
        QuantExp quantExp1 =
                new QuantExp(FAKE_LOCATION_1.clone(),
                        SymbolTableEntry.Quantification.EXISTENTIAL,
                        Collections.singletonList(new MathVarDec(new PosSymbol(
                                FAKE_LOCATION_1.clone(), "a"), new NameTy(
                                FAKE_LOCATION_1.clone(), null, new PosSymbol(
                                        FAKE_LOCATION_1.clone(), "Integer")))),
                        null, new EqualsExp(FAKE_LOCATION_1.clone(), MathExp
                                .getTrueVarExp(FAKE_LOCATION_1.clone(),
                                        FAKE_TYPEGRAPH), null,
                                EqualsExp.Operator.NOT_EQUAL, MathExp
                                        .getTrueVarExp(FAKE_LOCATION_1.clone(),
        ...
        QuantExp quantExp2 =
                new QuantExp(FAKE_LOCATION_2.clone(),
                        SymbolTableEntry.Quantification.EXISTENTIAL,
                        Collections.singletonList(new MathVarDec(new PosSymbol(
                                FAKE_LOCATION_2.clone(), "a"), new NameTy(
                                FAKE_LOCATION_2.clone(), null, new PosSymbol(
                                        FAKE_LOCATION_2.clone(), "Integer")))),
                        null, new EqualsExp(FAKE_LOCATION_2.clone(), MathExp
                                .getTrueVarExp(FAKE_LOCATION_2.clone(),
                                        FAKE_TYPEGRAPH), null,
                                EqualsExp.Operator.NOT_EQUAL, MathExp
                                        .getTrueVarExp(FAKE_LOCATION_2.clone(),
    ...
    public final void testSetCollectionExpressions() {
        // SetCollectionExp
        SetCollectionExp setCollectionExp1 =
                new SetCollectionExp(FAKE_LOCATION_1.clone(),
        ...
        SetCollectionExp setCollectionExp2 =
                new SetCollectionExp(FAKE_LOCATION_2.clone(),
                        new HashSet<>(Arrays.<MathExp>asList(
                                new VarExp(FAKE_LOCATION_2.clone(), null,
                                        new PosSymbol(FAKE_LOCATION_2.clone(), "C")),
                                new VarExp(FAKE_LOCATION_2.clone(), null,
        ...
        SetCollectionExp setCollectionExp3 =
                new SetCollectionExp(FAKE_LOCATION_2.clone(),
                        new HashSet<>(Arrays.<MathExp>asList(
                                new VarExp(FAKE_LOCATION_2.clone(), null,
                                        new PosSymbol(FAKE_LOCATION_2.clone(), "D")),
    ...
    /**
     * <p>This tests {@link SetExp#equals(Object)}} and
     * {@link SetExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testSetExpressions() {
        // SetExp
        SetExp setExp1 =
                new SetExp(FAKE_LOCATION_1.clone(), new MathVarDec(
                        new PosSymbol(FAKE_LOCATION_1.clone(), "a"),
                        new NameTy(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(),
                                        "Integer"))), null, new EqualsExp(
                        FAKE_LOCATION_1.clone(), MathExp.getTrueVarExp(
                                FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.NOT_EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_1.clone(), FAKE_TYPEGRAPH)));
        ...
        SetExp setExp2 =
                new SetExp(FAKE_LOCATION_2.clone(), new MathVarDec(
                        new PosSymbol(FAKE_LOCATION_2.clone(), "a"),
                        new NameTy(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(),
                                        "Integer"))), null, new EqualsExp(
                        FAKE_LOCATION_2.clone(), MathExp.getTrueVarExp(
                                FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH), null,
                        EqualsExp.Operator.NOT_EQUAL, MathExp.getTrueVarExp(
                                FAKE_LOCATION_2.clone(), FAKE_TYPEGRAPH)));
    ...
    /**
     * <p>This tests {@link TupleExp#equals(Object)}} and
     * {@link TupleExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testTupleExpressions() {
        // TupleExp
        TupleExp tupleExp1 =
                new TupleExp(FAKE_LOCATION_1.clone(), Arrays.<Exp> asList(
                        new VarExp(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(), "C")),
                        new VarExp(FAKE_LOCATION_1.clone(), null,
                                new PosSymbol(FAKE_LOCATION_1.clone(), "D"))));
        ...
        TupleExp tupleExp2 =
                new TupleExp(FAKE_LOCATION_2.clone(), Arrays.<Exp> asList(
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "C")),
                        new VarExp(FAKE_LOCATION_2.clone(), null,
                                new PosSymbol(FAKE_LOCATION_2.clone(), "D"))));
    ...
    /**
     * <p>This tests {@link UnaryMinusExp#equals(Object)}} and
     * {@link UnaryMinusExp#equivalent(Exp)}.</p>
     */
    @Test
    public final void testUnaryMinusExpressions() {
        // UnaryMinusExp
        UnaryMinusExp unaryMinusExp1 =
                new UnaryMinusExp(FAKE_LOCATION_1.clone(), new IntegerExp(
                        FAKE_LOCATION_1.clone(), null, 1));
        unaryMinusExp1.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_1
                .clone());

        UnaryMinusExp unaryMinusExp2 =
                new UnaryMinusExp(FAKE_LOCATION_2.clone(), new IntegerExp(
                        FAKE_LOCATION_2.clone(), null, 1));
        unaryMinusExp2.setLocationDetailModel(FAKE_LOCATION_DETAIL_MODEL_2
                .clone());
    ...
    /**
     * <p>This tests {@link VarExp#equals(Object)}},
     * {@link VarExp#equivalent(Exp)}, {@link VCVarExp#equals(Object)} and
     * {@link VCVarExp#equivalent(Exp)}}.</p>
     */
    @Test
    public final void testVarExpressions() {
        // VarExp
        VarExp varExp1 =
                new VarExp(FAKE_LOCATION_1.clone(), null, new PosSymbol(
                        FAKE_LOCATION_1.clone(), "C"));
    ...
    /**
     * <p>This method performs the assertion tests on the passed
     * in expressions.</p>
     *
     * @param exp1 A {@link Exp}.
     * @param exp2 Another {@link Exp}.
     */
