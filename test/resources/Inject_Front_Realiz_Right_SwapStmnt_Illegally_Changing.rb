Realization Inject_Front_Realiz_Right_SwapStmnt_Illegally_Changing for Inject_Front_Capability of Queue_Template;
...
end Inject_Front_Realiz_Right_SwapStmnt_Illegally_Changing;
